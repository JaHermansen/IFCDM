...
import { LoadIfcUIState } from "./src/template";
/**
 ...
 *
 */
export declare const loadIfc: (state: LoadIfcUIState) => [element: BUI.Button, update: (state?: Partial<LoadIfcUIState> | undefined) => LoadIfcUIState];
