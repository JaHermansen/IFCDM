 ...
 */
export declare const materialsListTemplate: (state: MaterialsListUIState) => BUI.TemplateResult<1>;
/**
 ...
 */
export declare const materialsList: (materials: THREE.Material[]) => [element: HTMLDivElement, update: (state?: Partial<MaterialsListUIState> | undefined) => MaterialsListUIState];
