...
import { RelationsTreeUIState } from "./src/template";
/**
 ...
 *
 */
export declare const relationsTree: (state: RelationsTreeUIState, autoUpdate?: boolean) => [element: BUI.Table, update: (state?: Partial<RelationsTreeUIState> | undefined) => RelationsTreeUIState];
