...
import { ClassificationTreeUIState } from "./src/template";
/**
 ...
 */
export declare const classificationTree: (state: ClassificationTreeUIState, autoUpdate?: boolean) => [element: BUI.Table, update: (state?: Partial<ClassificationTreeUIState> | undefined) => ClassificationTreeUIState];
