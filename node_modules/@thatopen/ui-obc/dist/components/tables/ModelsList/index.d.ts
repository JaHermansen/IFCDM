...
import { ModelsListUIState } from "./src/template";
/**
 ...
 */
export declare const modelsList: (state: ModelsListUIState, autoUpdate?: boolean) => [element: BUI.Table, update: (state?: Partial<ModelsListUIState> | undefined) => ModelsListUIState];
