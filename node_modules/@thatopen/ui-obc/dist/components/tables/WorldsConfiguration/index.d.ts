...
import { WorldsConfigurationUIState } from "./src/template";
/**
 ...
 */
export declare const worldsConfiguration: (state: WorldsConfigurationUIState, autoUpdate?: boolean) => [element: BUI.Table, update: (state?: Partial<WorldsConfigurationUIState> | undefined) => WorldsConfigurationUIState];
