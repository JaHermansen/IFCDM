...
import { Object3D as dr, Vector2 as pr, Vector3 as Zi, Matrix4 as xs } from "three";
var fr = Object.defineProperty, mr = (i, t, e) => t in i ? fr(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : i[t] = e, Ot = (i, t, e) => (mr(i, typeof t != "symbol" ? t + "" : t, e), e);
const Gt = Math.min, rt = Math.max, ti = Math.round, yt = (i) => ({
  x: i,
  y: i
}), br = {
  left: "right",
...
function vr(i, t, e) {
  e === void 0 && (e = !1);
  const s = di(i), n = Cs(i), o = $s(n);
  let r = n === "x" ? s === (e ? "end" : "start") ? "right" : "left" : s === "start" ? "bottom" : "top";
  return t.reference[o] > t.floating[o] && (r = ei(r)), [r, ei(r)];
}
function yr(i) {
  const t = ei(i);
  return [zi(i), t, zi(t)];
...
function zi(i) {
  return i.replace(/start|end/g, (t) => gr[t]);
}
function _r(i, t, e) {
...
function xr(i, t, e, s) {
  const n = di(i);
  let o = _r(at(i), e === "start", s);
  return n && (o = o.map((r) => r + "-" + n), t && (o = o.concat(o.map(zi)))), o;
}
function ei(i) {
  return i.replace(/left|right|bottom|top/g, (t) => br[t]);
}
function wr(i) {
  return {
    top: 0,
...
function Cn(i, t, e) {
  ...
  const o = Mt(t), r = Cs(t), a = $s(r), l = at(t), u = o === "y", h = s.x + s.width / 2 - n.width / 2, d = s.y + s.height / 2 - n.height / 2, c = s[a] / 2 - n[a] / 2;
  let p;
  switch (l) {
    case "top":
      p = {
...
const $r = async (i, t, e) => {
  ...
  for (let w = 0; w < a.length; w++) {
    ...
    }, $ && g <= 50 && (g++, typeof $ == "object" && ($.placement && (c = $.placement), $.rects && (u = $.rects === !0 ? await r.getElementRects({
      reference: i,
      floating: t,
      strategy: n
    }) : $.rects), {
...
async function tn(i, t) {
  ...
  const {
    ...
    altBoundary: c = !1,
    padding: p = 0
  } = Pe(t, i), g = Es(p), w = a[c ? d === "floating" ? "reference" : "floating" : d], _ = qt(await o.getClippingRect({
    ...
    x: 1,
    y: 1
  }, v = qt(o.convertOffsetParentRelativeRectToViewportRelativeRect ? await o.convertOffsetParentRelativeRectToViewportRelativeRect({
    elements: a,
    rect: x,
    offsetParent: m,
    strategy: l
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      ...
      if ((e = o.arrow) != null && e.alignmentOffset)
        return {};
      const x = at(n), m = Mt(a), b = at(a) === a, v = await (l.isRTL == null ? void 0 : l.isRTL(u.floating)), $ = c || (b || !w ? [ei(a)] : yr(a)), C = g !== "none";
      !c && C && $.push(...xr(a, w, g, v));
      const E = [a, ...$], A = await tn(t, _), j = [];
      ...
      if (O = [...O, {
        ...
        var G, kt;
        const U = (((G = o.flip) == null ? void 0 : G.index) || 0) + 1, dt = E[U];
        if (dt)
          return {
            data: {
              index: U,
        ...
        let H = (kt = O.filter((et) => et.overflows[0] <= 0).sort((et, q) => et.overflows[1] - q.overflows[1])[0]) == null ? void 0 : kt.placement;
        if (!H)
          switch (p) {
            case "bestFit": {
              var ht;
              const et = (ht = O.filter((q) => {
                if (C) {
                  const it = Mt(q.placement);
                  return it === m || // Create a bias to the `y` side axis due to horizontal
                  // reading directions favoring greater width.
                  it === "y";
                }
                return !0;
              }).map((q) => [q.placement, q.overflows.filter((it) => it > 0).reduce((it, xn) => it + xn, 0)]).sort((q, it) => q[1] - it[1])[0]) == null ? void 0 : ht[0];
              et && (H = et);
              break;
            }
...
function As(i) {
  const t = Gt(...i.map((o) => o.left)), e = Gt(...i.map((o) => o.top)), s = rt(...i.map((o) => o.right)), n = rt(...i.map((o) => o.bottom));
  return {
    x: t,
    y: e,
    width: s - t,
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: l,
        y: u
      } = Pe(i, t), h = Array.from(await (o.getClientRects == null ? void 0 : o.getClientRects(s.reference)) || []), d = Er(h), c = qt(As(h)), p = Es(a);
      function g() {
        ...
        if (d.length >= 2) {
          if (Mt(e) === "y") {
            const O = d[0], G = d[d.length - 1], kt = at(e) === "top", ht = O.top, U = G.bottom, dt = kt ? O.left : G.left, H = kt ? O.right : G.right, et = H - dt, q = U - ht;
            return {
              top: ht,
              bottom: U,
              left: dt,
          ...
          const _ = at(e) === "left", x = rt(...d.map((O) => O.right)), m = Gt(...d.map((O) => O.left)), b = d.filter((O) => _ ? O.left === m : O.right === x), v = b[0].top, $ = b[b.length - 1].bottom, C = m, E = x, A = E - C, j = $ - v;
          return {
            top: v,
            bottom: $,
            left: C,
...
async function Sr(i, t) {
  const {
    ...
    platform: s,
    elements: n
  } = i, o = await (s.isRTL == null ? void 0 : s.isRTL(n.floating)), r = at(e), a = di(e), l = Mt(e) === "y", u = ["left", "top"].includes(r) ? -1 : 1, h = o && l ? -1 : 1, d = Pe(t, i);
  let {
    mainAxis: c,
    crossAxis: p,
    alignmentAxis: g
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: e,
        y: s
      }, h = await tn(t, l), d = Mt(at(n)), c = ws(d);
      let p = u[c], g = u[d];
      if (o) {
...
function Or(i) {
  return ["table", "td", "th"].includes(_t(i));
}
function Tr(i) {
...
function pi(i) {
  return ["html", "body", "#document"].includes(_t(i));
}
function X(i) {
...
function Os(i) {
  const t = Yt(i);
  return pi(t) ? i.ownerDocument ? i.ownerDocument.body : i.body : nt(t) && Re(t) ? t : Os(t);
}
function Di(i, t, e) {
  var s;
  t === void 0 && (t = []), e === void 0 && (e = !0);
  const n = Os(i), o = n === ((s = i.ownerDocument) == null ? void 0 : s.body), r = V(n);
  return o ? t.concat(r, r.visualViewport || [], Re(n) ? n : [], r.frameElement && e ? Di(r.frameElement) : []) : t.concat(n, Di(n, [], e));
}
function Ts(i) {
  const t = X(i);
  let e = parseFloat(t.width) || 0, s = parseFloat(t.height) || 0;
  const n = nt(i), o = n ? i.offsetWidth : e, r = n ? i.offsetHeight : s, a = ti(e) !== o || ti(s) !== r;
  return a && (e = o, s = r), {
    width: e,
    height: s,
    $: a
...
function Vt(i) {
  ...
  let r = (o ? ti(e.width) : e.width) / s, a = (o ? ti(e.height) : e.height) / n;
  return (!r || !Number.isFinite(r)) && (r = 1), (!a || !Number.isFinite(a)) && (a = 1), {
    x: r,
    y: a
  };
}
const Pr = /* @__PURE__ */ yt(0);
function Ps(i) {
  const t = V(i);
  return !nn() || !t.visualViewport ? Pr : {
...
function we(i, t, e, s) {
  ...
  const n = i.getBoundingClientRect(), o = Is(i);
  let r = yt(1);
  t && (s ? lt(s) && (r = Vt(s)) : r = Vt(i));
  const a = Rr(o, e, s) ? Ps(o) : yt(0);
  let l = (n.left + a.x) / r.x, u = (n.top + a.y) / r.y, h = n.width / r.x, d = n.height / r.y;
  if (o) {
    const c = V(o), p = s && lt(s) ? V(s) : s;
    let g = c, w = g.frameElement;
    for (; w && s && p !== g; ) {
      const _ = Vt(w), x = w.getBoundingClientRect(), m = X(w), b = x.left + (w.clientLeft + parseFloat(m.paddingLeft)) * _.x, v = x.top + (w.clientTop + parseFloat(m.paddingTop)) * _.y;
      l *= _.x, u *= _.y, h *= _.x, d *= _.y, l += b, u += v, g = V(w), w = g.frameElement;
    }
  }
  return qt({
    width: h,
...
function Mr(i) {
  ...
  const o = n === "fixed", r = wt(s), a = t ? Rs(t.floating) : !1;
  if (s === r || a && o)
    return e;
  let l = {
    scrollLeft: 0,
  ...
  const h = yt(0), d = nt(s);
  if ((d || !d && !o) && ((_t(s) !== "body" || Re(r)) && (l = fi(s)), nt(s))) {
    const c = we(s);
...
function zr(i) {
  const t = wt(i), e = fi(i), s = i.ownerDocument.body, n = rt(t.scrollWidth, t.clientWidth, s.scrollWidth, s.clientWidth), o = rt(t.scrollHeight, t.clientHeight, s.scrollHeight, s.clientHeight);
  let r = -e.scrollLeft + Ns(i);
  const a = -e.scrollTop;
  return X(s).direction === "rtl" && (r += rt(t.clientWidth, s.clientWidth) - n), {
    width: n,
    height: o,
    x: r,
    y: a
...
function jr(i, t) {
  const e = we(i, !0, t === "fixed"), s = e.top + i.clientTop, n = e.left + i.clientLeft, o = nt(i) ? Vt(i) : yt(1), r = i.clientWidth * o.x, a = i.clientHeight * o.y, l = n * o.x, u = s * o.y;
  return {
    width: r,
    height: a,
    x: l,
...
function Hr(i, t) {
  ...
  if (e)
    return e;
  let s = Di(i, [], !1).filter((a) => lt(a) && _t(a) !== "body"), n = null;
  const o = X(i).position === "fixed";
  let r = o ? Yt(i) : i;
  for (; lt(r) && !pi(r); ) {
    const a = X(r), l = en(r);
    !l && a.position === "fixed" && (n = null), (o ? !l && !n : !l && a.position === "static" && n && ["absolute", "fixed"].includes(n.position) || Re(r) && !l && Ms(i, r)) ? s = s.filter((u) => u !== r) : n = a, r = Yt(r);
  }
  return t.set(i, s), s;
}
function Fr(i) {
  ...
  const o = [...e === "clippingAncestors" ? Hr(t, this._c) : [].concat(e), s], r = o[0], a = o.reduce((l, u) => {
    const h = An(t, u, n);
    return l.top = rt(h.top, l.top), l.right = Gt(h.right, l.right), l.bottom = Gt(h.bottom, l.bottom), l.left = rt(h.left, l.left), l;
  }, An(t, r, n));
  return {
...
function Ur(i, t, e) {
  const s = nt(t), n = wt(t), o = e === "fixed", r = we(i, !0, o, t);
  let a = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
function Sn(i, t) {
  return !nt(i) || X(i).position === "fixed" ? null : t ? t(i) : i.offsetParent;
}
function Ls(i, t) {
  const e = V(i);
  if (!nt(i) || Rs(i))
    return e;
  let s = Sn(i, t);
  for (; s && Or(s) && X(s).position === "static"; )
    s = Sn(s, t);
  return s && (_t(s) === "html" || _t(s) === "body" && X(s).position === "static" && !en(s)) ? e : s || Ir(i) || e;
}
const Vr = async function(i) {
  const t = this.getOffsetParent || Ls, e = this.getDimensions;
  return {
    reference: Ur(i.reference, await t(i.floating), i.strategy),
    floating: {
      x: 0,
      y: 0,
      ...await e(i.floating)
 ...
 */
const Je = globalThis, sn = Je.ShadowRoot && (Je.ShadyCSS === void 0 || Je.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, on = Symbol(), kn = /* @__PURE__ */ new WeakMap();
let Fs = class {
  constructor(i, t, e) {
    if (this._$cssResult$ = !0, e !== on)
...
const qr = (i) => new Fs(typeof i == "string" ? i : i + "", void 0, on), T = (i, ...t) => {
...
}, On = sn ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Xr, defineProperty: Jr, getOwnPropertyDescriptor: Qr, getOwnPropertyNames: Kr, getOwnPropertySymbols: Zr, getPrototypeOf: ta } = Object, Xt = globalThis, Tn = Xt.trustedTypes, ea = Tn ? Tn.emptyScript : "", In = Xt.reactiveElementPolyfillSupport, be = (i, t) => i, ii = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? ea : null;
      break;
  ...
  return e;
} }, rn = (i, t) => !Xr(i, t), Pn = { attribute: !0, type: String, converter: ii, reflect: !1, hasChanged: rn };
...
class Bt extends HTMLElement {
  ...
  static createProperty(t, e = Pn) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.elementProperties.set(t, e), !e.noAccessor) {
      ...
      n !== void 0 && Jr(this.prototype, t, n);
    }
  }
  static getPropertyDescriptor(t, e, s) {
    const { get: n, set: o } = Qr(this.prototype, t) ?? { get() {
      return this[e];
    }, set(r) {
      this[e] = r;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(be("properties"))) {
      const e = this.properties, s = [...Kr(e), ...Zr(e)];
      for (const n of s)
  ...
  _$EC(t, e) {
    ...
    if (o !== void 0 && n.reflect === !0) {
      const r = (((s = n.converter) == null ? void 0 : s.toAttribute) !== void 0 ? n.converter : ii).toAttribute(e, n.type);
  ...
  _$AK(t, e) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const r = n.getPropertyOptions(o), a = typeof r.converter == "function" ? { fromAttribute: r.converter } : ((s = r.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? r.converter : ii;
      this._$Em = o, this[o] = a.fromAttribute(e, r.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, s) {
    if (t !== void 0) {
      if (s ?? (s = this.constructor.getPropertyOptions(t)), !(s.hasChanged ?? rn)(this[t], e))
        return;
      this.P(t, e, s);
    }
...
Bt.elementStyles = [], Bt.shadowRootOptions = { mode: "open" }, Bt[be("elementProperties")] = /* @__PURE__ */ new Map(), Bt[be("finalized")] = /* @__PURE__ */ new Map(), In == null || In({ ReactiveElement: Bt }), (Xt.reactiveElementVersions ?? (Xt.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ni = globalThis, si = ni.trustedTypes, Rn = si ? si.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, Bs = "$lit$", mt = `lit$${Math.random().toFixed(9).slice(2)}$`, Us = "?" + mt, ia = `<${Us}>`, Lt = document, $e = () => Lt.createComment(""), Ce = (i) => i === null || typeof i != "object" && typeof i != "function", Vs = Array.isArray, na = (i) => Vs(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Si = `[ 	
\f\r]`, pe = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Nn = /-->/g, Mn = />/g, Tt = RegExp(`>|${Si}(?:([^\\s"'>=/]+)(${Si}*=${Si}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ln = /'/g, zn = /"/g, Ws = /^(?:script|style|textarea|title)$/i, sa = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), y = sa(1), Jt = Symbol.for("lit-noChange"), M = Symbol.for("lit-nothing"), Dn = /* @__PURE__ */ new WeakMap(), Pt = Lt.createTreeWalker(Lt, 129);
function Gs(i, t) {
...
const oa = (i, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    for (; c < l.length && (r.lastIndex = c, h = r.exec(l), h !== null); )
      c = r.lastIndex, r === pe ? h[1] === "!--" ? r = Nn : h[1] !== void 0 ? r = Mn : h[2] !== void 0 ? (Ws.test(h[2]) && (n = RegExp("</" + h[2], "g")), r = Tt) : h[3] !== void 0 && (r = Tt) : r === Tt ? h[0] === ">" ? (r = n ?? pe, d = -1) : h[1] === void 0 ? d = -2 : (d = r.lastIndex - h[2].length, u = h[1], r = h[3] === void 0 ? Tt : h[3] === '"' ? zn : Ln) : r === zn || r === Ln ? r = Tt : r === Nn || r === Mn ? r = pe : (r = Tt, n = void 0);
    const p = r === Tt && i[a + 1].startsWith("/>") ? " " : "";
    o += r === pe ? l + ia : d >= 0 ? (s.push(u), l.slice(0, d) + Bs + l.slice(d) + mt + p) : l + mt + (d === -2 ? a : p);
  }
  return [Gs(i, o + (i[e] || "<?>") + (t === 2 ? "</svg>" : "")), s];
};
class Ee {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let o = 0, r = 0;
    const a = t.length - 1, l = this.parts, [u, h] = oa(t, e);
      ...
      if (n.nodeType === 1) {
        if (n.hasAttributes())
          for (const d of n.getAttributeNames())
            if (d.endsWith(Bs)) {
              const c = h[r++], p = n.getAttribute(d).split(mt), g = /([.?@])?(.*)/.exec(c);
              l.push({ type: 1, index: o, name: g[2], strings: p, ctor: g[1] === "." ? aa : g[1] === "?" ? la : g[1] === "@" ? ca : mi }), n.removeAttribute(d);
            } else
              d.startsWith(mt) && (l.push({ type: 6, index: o }), n.removeAttribute(d));
        if (Ws.test(n.tagName)) {
          const d = n.textContent.split(mt), c = d.length - 1;
          if (c > 0) {
            n.textContent = si ? si.emptyScript : "";
            for (let p = 0; p < c; p++)
              n.append(d[p], $e()), Pt.nextNode(), l.push({ type: 2, index: ++o });
            n.append(d[c], $e());
          }
        }
        ...
        if (n.data === Us)
          ...
          for (; (d = n.data.indexOf(mt, d + 1)) !== -1; )
            l.push({ type: 7, index: o }), d += mt.length - 1;
        }
      o++;
    }
  }
...
function Qt(i, t, e = i, s) {
  ...
  return (r == null ? void 0 : r.constructor) !== a && ((o = r == null ? void 0 : r._$AO) == null || o.call(r, !1), a === void 0 ? r = void 0 : (r = new a(i), r._$AT(i, e, s)), s !== void 0 ? (e._$Co ?? (e._$Co = []))[s] = r : e._$Cl = r), r !== void 0 && (t = Qt(i, r._$AS(i, t.values), r, s)), t;
}
class ra {
  constructor(t, e) {
  ...
  u(t) {
    ...
    Pt.currentNode = n;
    let o = Pt.nextNode(), r = 0, a = 0, l = s[0];
    for (; l !== void 0; ) {
      if (r === l.index) {
        let u;
        l.type === 2 ? u = new Ne(o, o.nextSibling, this, t) : l.type === 1 ? u = new l.ctor(o, l.name, l.strings, this, t) : l.type === 6 && (u = new ua(o, this, t)), this._$AV.push(u), l = s[++a];
      }
      r !== (l == null ? void 0 : l.index) && (o = Pt.nextNode(), r++);
    }
...
class Ne {
  ...
  _$AI(t, e = this) {
    t = Qt(this, t, e), Ce(t) ? t === M || t == null || t === "" ? (this._$AH !== M && this._$AR(), this._$AH = M) : t !== this._$AH && t !== Jt && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : na(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  $(t) {
    var e;
    const { values: s, _$litType$: n } = t, o = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = Ee.createElement(Gs(n.h, n.h[0]), this.options)), n);
    if (((e = this._$AH) == null ? void 0 : e._$AD) === o)
      this._$AH.p(s);
    else {
      const r = new ra(o, this), a = r.u(this.options);
  ...
  k(t) {
    ...
    let s, n = 0;
    for (const o of t)
      n === e.length ? e.push(s = new Ne(this.S($e()), this.S($e()), this, this.options)) : s = e[n], s._$AI(o), n++;
...
class mi {
  ...
  _$AI(t, e = this, s, n) {
    ...
    let r = !1;
    if (o === void 0)
      t = Qt(this, t, e, 0), r = !Ce(t) || t !== this._$AH && t !== Jt, r && (this._$AH = t);
    else {
      const a = t;
      let l, u;
      for (t = o[0], l = 0; l < o.length - 1; l++)
        u = Qt(this, a[s + l], e, l), u === Jt && (u = this._$AH[l]), r || (r = !Ce(u) || u !== this._$AH[l]), u === M ? t = M : t !== M && (t += (u ?? "") + o[l + 1]), this._$AH[l] = u;
    }
    r && !n && this.j(t);
  }
  j(t) {
...
const Kt = (i, t, e) => {
  ...
  if (n === void 0) {
    ...
    s._$litPart$ = n = new Ne(t.insertBefore($e(), o), o, void 0, e ?? {});
  }
  return n._$AI(i), n;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ha = { attribute: !0, type: String, converter: ii, reflect: !1, hasChanged: rn }, da = (i = ha, t, e) => {
...
function f(i) {
  return (t, e) => typeof e == "object" ? da(i, t, e) : ((s, n, o) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const fa = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, ma = (i) => (...t) => ({ _$litDirective$: i, values: t });
let ba = class {
  constructor(i) {
  }
  get _$AU() {
...
function ga(i) {
  this._$AN !== void 0 ? (oi(this), this._$AM = i, qs(this)) : this._$AM = i;
}
...
const ya = (i) => {
  i.type == fa.CHILD && (i._$AP ?? (i._$AP = va), i._$AQ ?? (i._$AQ = ga));
};
class _a extends ba {
  constructor() {
  ...
  _$AO(t, e = !0) {
    var s, n;
    t !== this.isConnected && (this.isConnected = t, t ? (s = this.reconnected) == null || s.call(this) : (n = this.disconnected) == null || n.call(this)), e && (ge(this, t), oi(this));
  }
  setValue(t) {
    if (pa(this._$Ct))
...
const ki = /* @__PURE__ */ new WeakMap(), Q = ma(class extends _a {
  render(i) {
    return M;
  }
  update(i, [t]) {
  ...
  rt(i) {
    if (this.isConnected || (i = void 0), typeof this.Y == "function") {
      ...
      let e = ki.get(t);
      e === void 0 && (e = /* @__PURE__ */ new WeakMap(), ki.set(t, e)), e.get(this.Y) !== void 0 && this.Y.call(this.ht, void 0), e.set(this.Y, i), i !== void 0 && this.Y.call(this.ht, i);
    } else
      this.Y.value = i;
  }
  get lt() {
    var i, t;
    return typeof this.Y == "function" ? (i = ki.get(this.ht ?? globalThis)) == null ? void 0 : i.get(this.Y) : (t = this.Y) == null ? void 0 : t.value;
  }
  disconnected() {
...
function Bn(i) {
  ...
  return t.width = e("width", null), t.height = e("height", null), t.rotate = $a(e("rotate", "")), Ea(t, e("flip", "")), t.preserveAspectRatio = e("preserveAspectRatio", e("preserveaspectratio", "")), t;
}
function Aa(i, t) {
  for (const e in Js)
    if (i[e] !== t[e])
...
function Un(i, t) {
  const e = Sa(i, t);
  for (const s in ji)
    s in ri ? s in i && !(s in e) && (e[s] = ri[s]) : s in t ? e[s] = t[s] : s in i && (e[s] = i[s]);
  return e;
}
function ka(i, t) {
...
function Ks(i) {
  if (typeof i != "object" || i === null)
    return null;
  const t = i;
  if (typeof t.prefix != "string" || !i.icons || typeof i.icons != "object" || !Oi(i, Ta))
    return null;
  const e = t.icons;
  for (const n in e) {
    const o = e[n];
    if (!n.match(ve) || typeof o.body != "string" || !Oi(
      o,
      ji
    ))
      return null;
  ...
  for (const n in s) {
    ...
    if (!n.match(ve) || typeof r != "string" || !e[r] && !s[r] || !Oi(
      o,
      ji
    ))
      return null;
...
function Se(i) {
  ...
  if (t) {
    const e = xt(t.provider, t.prefix), s = t.name;
...
function to(i, t) {
  ...
  if (!e)
    return !1;
  const s = xt(e.provider, e.prefix);
  return Pa(s, e.name, t);
}
function Vn(i, t) {
  if (typeof i != "object")
    return !1;
...
function Ma(i) {
  ...
  return i.forEach((n) => {
    if (s.name === n.name && s.prefix === n.prefix && s.provider === n.provider)
      return;
    s = n;
    const o = n.provider, r = n.prefix, a = n.name, l = e[o] || (e[o] = /* @__PURE__ */ Object.create(null)), u = l[r] || (l[r] = xt(o, r));
    let h;
...
function ja(i, t = !0, e = !1) {
  const s = [];
  return i.forEach((n) => {
    const o = typeof n == "string" ? ze(n, t, e) : n;
    o && s.push(o);
  }), s;
}
var Ha = {
...
for (; qe.length > 0; )
  qe.length === 1 || Math.random() > 0.5 ? Bi.push(qe.shift()) : Bi.push(qe.pop());
bi[""] = ln({
...
function no(i, t, e) {
  ...
  if (typeof i == "string") {
    ...
    if (o) {
      s = io(o);
      const r = i.resources ? i.resources[0] : "", a = Fi(r);
      a && (n = a.send);
    }
  }
  return !s || !n ? (e(void 0, 424), Yn) : s.query(t, n, e)().abort;
}
const Xn = "iconify2", ke = "iconify", so = ke + "-count", Jn = ke + "-version", oo = 36e5, Va = 168, Wa = 50;
function Ui(i, t) {
  try {
    return i.getItem(t);
  } catch {
...
function Vi(i, t) {
  return cn(i, so, t.toString());
}
function Wi(i) {
  return parseInt(Ui(i, so)) || 0;
}
const Nt = {
  local: !0,
  session: !0
...
function lo(i, t) {
  ...
  const n = Math.floor(Date.now() / oo) - Va, o = (a) => {
    const l = ke + a.toString(), u = Ui(e, l);
    if (typeof u == "string") {
      try {
...
function co() {
  if (!un) {
    ...
    for (const i in Nt)
      lo(i, (t) => {
        const e = t.data, s = t.provider, n = e.prefix, o = xt(
          s,
          n
        );
        if (!an(o, e).length)
...
function Ya(i, t) {
  ...
  function e(s) {
    ...
    else if (r = Wi(n), r >= Wa || !Vi(n, r + 1))
      return;
    const a = {
      cached: Math.floor(Date.now() / oo),
      provider: i.provider,
      data: t
    };
    return cn(
  ...
  t.lastModified && !qa(i, t.lastModified) || Object.keys(t.icons).length && (t.not_found && (t = Object.assign({}, t), delete t.not_found), e("local") || e("session"));
}
function Kn() {
}
function Xa(i) {
  i.iconsLoaderFlag || (i.iconsLoaderFlag = !0, setTimeout(() => {
    i.iconsLoaderFlag = !1, La(i);
  }));
}
function Ja(i, t) {
  i.iconsToLoad ? i.iconsToLoad = i.iconsToLoad.concat(t).sort() : i.iconsToLoad = t, i.iconsQueueFlag || (i.iconsQueueFlag = !0, setTimeout(() => {
    ...
    let o;
    !n || !(o = Fi(e)) || o.prepare(e, s, n).forEach((r) => {
      no(e, r, (a) => {
        if (typeof a != "object")
          r.icons.forEach((l) => {
            i.missing.add(l);
...
const hn = (i, t) => {
  ...
  return s.pending.forEach((l) => {
    ...
    if (h === a && u === r)
      return;
    r = u, a = h, o.push(xt(u, h));
    const d = n[u] || (n[u] = /* @__PURE__ */ Object.create(null));
    d[h] || (d[h] = []);
  }), s.pending.forEach((l) => {
    const { provider: u, prefix: h, name: d } = l, c = xt(u, h), p = c.pendingIcons || (c.pendingIcons = /* @__PURE__ */ new Set());
    p.has(d) || (p.add(d), n[u][h].push(d));
  }), o.forEach((l) => {
    const { provider: u, prefix: h } = l;
    n[u][h].length && Ja(l, n[u][h]);
  }), t ? Da(t, s, o) : Kn;
}, Qa = (i) => new Promise((t, e) => {
...
function tl(i, t) {
  ...
  return t !== "style" && (uo || i.indexOf("<a") === -1) ? "svg" : i.indexOf("currentColor") === -1 ? "bg" : "mask";
}
const el = /(-?[0-9.]*[0-9]+[0-9.]*)/g, il = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function Gi(i, t, e) {
  if (t === 1)
    return i;
...
function ol(i, t, e) {
  const s = nl(i);
  return sl(s.defs, t + s.content + e);
}
...
function ho(i, t) {
  ...
  [e, s].forEach((w) => {
    ...
    b % 2 === 1 && (n.left !== n.top && (v = n.left, n.left = n.top, n.top = v), n.width !== n.height && (v = n.width, n.width = n.height, n.height = v)), _.length && (o = ol(
      o,
      '<g transform="' + _.join(" ") + '">',
      "</g>"
    ));
  ...
  let h, d;
  r === null ? (d = a === null ? "1em" : a === "auto" ? u : a, h = Gi(d, l / u)) : (h = r === "auto" ? l : r, d = a === null ? Gi(h, u / l) : a === "auto" ? u : a);
  const c = {}, p = (w, _) => {
    rl(_) || (c[w] = _.toString());
  };
...
function ll(i) {
  return "data:image/svg+xml," + al(i);
}
function po(i) {
  return 'url("' + ll(i) + '")';
}
...
function ts(i, t) {
  let e = Array.from(i.childNodes).find((s) => s.hasAttribute && s.hasAttribute(Pi));
  e || (e = document.createElement("style"), e.setAttribute(Pi, Pi), i.appendChild(e)), e.textContent = ":host{display:inline-block;vertical-align:" + (t ? "-0.125em" : "0") + "}span,svg{display:block}" + fo;
}
function mo() {
  Gn("", gl), Zs(!0);
  let i;
...
function xl(i) {
  return ye === void 0 && _l(), ye ? ye.createHTML(i) : i;
}
function wl(i) {
  ...
  const n = dn(i.body, e);
  return t.innerHTML = xl(n), t.firstChild;
}
function Yi(i) {
...
function ss(i, t) {
  const e = t.icon.data, s = t.customisations, n = ho(e, s);
  ...
  const n = [
    ...
    */
    ...
    _check() {
      ...
      (a.attrMode !== u || Aa(a.customisations, h) || !Yi(this._shadowRoot)) && this._renderIcon(a.icon, h, u);
    }
    /**
    ...
    _iconChanged(a) {
      ...
      l.data ? this._gotIconData(l) : this._state = os(l, this._state.inline, this._state);
    }
    /**
     ...
     */
    _renderIcon(a, l, u) {
      const h = tl(a.data.body, u), d = this._state.inline;
...
$l() || mo();
var Cl = Object.defineProperty, st = (i, t, e, s) => {
  for (var n = void 0, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && Cl(t, e, n), n;
}, Xe;
const Z = (Xe = class extends k {
  constructor() {
    super(), this.labelHidden = !1, this.active = !1, this.disabled = !1, this.vertical = !1, this.tooltipVisible = !1, this._parent = gt(), this._tooltip = gt(), this._contextMenu = gt(), this._mouseLeave = !1, this.onWindowMouseUp = (i) => {
...
st([
  f({ type: Boolean, attribute: "label-hidden", reflect: !0 })
], Z.prototype, "labelHidden");
st([
  f({ type: Boolean, reflect: !0 })
], Z.prototype, "active");
st([
  f({ type: Boolean, reflect: !0, attribute: "disabled" })
...
st([
  f({ type: Number, attribute: "tooltip-time", reflect: !0 })
], Z.prototype, "tooltipTime");
st([
  f({ type: Boolean, attribute: "tooltip-visible", reflect: !0 })
], Z.prototype, "tooltipVisible");
st([
  f({ type: String, attribute: "tooltip-title", reflect: !0 })
], Z.prototype, "tooltipTitle");
st([
  f({ type: String, attribute: "tooltip-text", reflect: !0 })
], Z.prototype, "tooltipText");
let El = Z;
var Al = Object.defineProperty, De = (i, t, e, s) => {
  for (var n = void 0, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && Al(t, e, n), n;
};
const go = class extends k {
  constructor() {
...
var Sl = Object.defineProperty, ne = (i, t, e, s) => {
  for (var n = void 0, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && Sl(t, e, n), n;
};
const vo = class extends k {
  constructor() {
    super(...arguments), this.vertical = !1, this.color = "#bcf124", this._colorInput = gt(), this._textInput = gt(), this.onValueChange = new Event("input"), this.onOpacityInput = (t) => {
      const e = t.target;
...
var Tl = Object.defineProperty, Il = Object.getOwnPropertyDescriptor, Pl = (i, t, e, s) => {
  for (var n = Il(t, e), o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && Tl(t, e, n), n;
};
const yo = class extends k {
  constructor() {
    super(...arguments), this._visible = !1, this._middleware = {
      name: "middleware",
      async fn(t) {
        const { right: e, top: s } = await tn(t);
...
class $t extends k {
  ...
  static create(t, e) {
    ...
    if (t.length === 0)
      return Kt(t(), s), s.firstElementChild;
    if (!e)
      throw new Error(
        "UIComponent: Initial state is required for statefull components."
      );
    let n = e;
    const o = t, r = (a) => (n = { ...n, ...a }, Kt(o(n), s), n);
...
const ci = (i, t = !0) => {
  ...
  return e;
}, vi = (i) => i === "true" || i === "false" ? i === "true" : i && !isNaN(Number(i)) && i.trim() !== "" ? Number(i) : i, Rl = [">=", "<=", "=", ">", "<", "?", "/", "#"];
function rs(i) {
  const t = Rl.find(
    (r) => i.split(r).length === 2
  ), e = i.split(t).map((r) => r.trim()), [s, n] = e, o = n.startsWith("'") && n.endsWith("'") ? n.replace(/'/g, "") : vi(n);
...
var Nl = Object.defineProperty, Ml = Object.getOwnPropertyDescriptor, Ct = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? Ml(t, e) : t, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
  return s && n && Nl(t, e, n), n;
};
const xo = class extends k {
  constructor() {
...
Ct([
  f({ type: Boolean, attribute: "no-mark", reflect: !0 })
...
var Ll = Object.defineProperty, zl = Object.getOwnPropertyDescriptor, Et = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? zl(t, e) : t, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
  return s && n && Ll(t, e, n), n;
};
const wo = class extends $t {
  constructor() {
    super(), this.multiple = !1, this.required = !1, this.vertical = !1, this._inputContainer = gt(), this._listElement = gt(), this._visible = !1, this._value = [], this.onValueChange = new Event("change"), this.onWindowMouseUp = (t) => {
  ...
  updateOptionsState() {
    for (const t of this._options)
      t instanceof L && (this._value.includes(t) ? t.checked = !0 : t.checked = !1);
  }
  findOption(t) {
    return this._options.find((e) => e instanceof L ? e.label === t || e.value === t : !1);
  }
  connectedCallback() {
    super.connectedCallback(), window.addEventListener("mouseup", this.onWindowMouseUp);
  }
...
var Dl = Object.defineProperty, $o = (i, t, e, s) => {
  for (var n = void 0, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && Dl(t, e, n), n;
};
const Co = class extends k {
  constructor() {
...
$o([
  f({ type: Boolean, reflect: !0 })
], pn.prototype, "floating");
$o([
  f({ type: String, reflect: !0 })
], pn.prototype, "layout");
const Ji = class extends k {
  render() {
    return y`
...
let jl = Ji;
var Hl = Object.defineProperty, yi = (i, t, e, s) => {
  for (var n = void 0, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && Hl(t, e, n), n;
};
const Eo = class extends k {
  constructor() {
...
var Fl = Object.defineProperty, He = (i, t, e, s) => {
  for (var n = void 0, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && Fl(t, e, n), n;
};
const Ao = class extends k {
  constructor() {
...
He([
  f({ type: Boolean, attribute: "icon-hidden", reflect: !0 })
], se.prototype, "iconHidden");
He([
  f({ type: Boolean, reflect: !0 })
], se.prototype, "vertical");
var Bl = Object.defineProperty, Ul = Object.getOwnPropertyDescriptor, J = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? Ul(t, e) : t, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
  return s && n && Bl(t, e, n), n;
};
const So = class extends k {
  constructor() {
    super(...arguments), this._value = 0, this.vertical = !1, this.slider = !1, this._input = gt(), this.onValueChange = new Event("change");
  }
  set value(t) {
...
var Vl = Object.defineProperty, Wl = Object.getOwnPropertyDescriptor, Fe = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? Wl(t, e) : t, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
  return s && n && Vl(t, e, n), n;
};
const ko = class extends k {
  constructor() {
...
Fe([
  f({ type: Boolean, reflect: !0 })
], oe.prototype, "hidden", 1);
Fe([
  f({ type: Boolean, attribute: "header-hidden", reflect: !0 })
], oe.prototype, "headerHidden", 2);
var Gl = Object.defineProperty, Be = (i, t, e, s) => {
  for (var n = void 0, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && Gl(t, e, n), n;
};
const Oo = class extends k {
  constructor() {
...
Be([
  f({ type: Boolean, reflect: !0 })
], re.prototype, "collapsed");
var ql = Object.defineProperty, Ue = (i, t, e, s) => {
  for (var n = void 0, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && ql(t, e, n), n;
};
const To = class extends k {
  constructor() {
  ...
  onSlotChange(t) {
    const e = t.target.assignedElements();
    for (const s of e)
      s instanceof L && (s.noMark = !0, s.removeEventListener("click", this.onOptionClick), s.addEventListener("click", this.onOptionClick));
  }
  findOption(t) {
    return this._options.find((e) => e instanceof L ? e.label === t || e.value === t : !1);
  }
...
var Yl = Object.defineProperty, Xl = (i, t, e, s) => {
  for (var n = void 0, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && Yl(t, e, n), n;
};
const Io = class extends k {
  constructor() {
...
var Jl = Object.defineProperty, Ql = (i, t, e, s) => {
  for (var n = void 0, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && Jl(t, e, n), n;
};
const Ro = class extends k {
  constructor() {
...
var Kl = Object.defineProperty, Zl = (i, t, e, s) => {
  for (var n = void 0, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && Kl(t, e, n), n;
};
const Mo = class extends k {
  constructor() {
...
let Lo = Mo;
Zl([
  f({ type: Boolean, attribute: "children-hidden", reflect: !0 })
], Lo.prototype, "childrenHidden");
var tc = Object.defineProperty, Ve = (i, t, e, s) => {
  for (var n = void 0, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && tc(t, e, n), n;
};
const zo = class extends k {
  constructor() {
  ...
  compute() {
    ...
    for (const a in o) {
      ...
      const l = o[a];
      let u;
      if (typeof l == "string" || typeof l == "boolean" || typeof l == "number" ? (u = document.createElement("bim-label"), u.textContent = String(l)) : l instanceof HTMLElement ? u = l : (u = document.createDocumentFragment(), Kt(l, u)), !u)
        continue;
...
Ve([
  f({ type: Boolean, attribute: "is-header", reflect: !0 })
], le.prototype, "isHeader");
Ve([
  Me()
], le.prototype, "_intersecting");
var ec = Object.defineProperty, ic = Object.getOwnPropertyDescriptor, ce = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? ic(t, e) : t, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
  return s && n && ec(t, e, n), n;
};
const Do = class extends k {
  constructor() {
...
ce([
  f({ type: String, attribute: "min-col-width", reflect: !0 })
...
var nc = Object.defineProperty, sc = Object.getOwnPropertyDescriptor, _i = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? sc(t, e) : t, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
  return s && n && nc(t, e, n), n;
};
const jo = class extends k {
  constructor() {
...
var oc = Object.defineProperty, rc = Object.getOwnPropertyDescriptor, ue = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? rc(t, e) : t, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
  return s && n && oc(t, e, n), n;
};
const Ho = class extends k {
  constructor() {
...
ue([
  f({ type: Boolean, attribute: "switchers-hidden", reflect: !0 })
...
ue([
  f({ type: Boolean, attribute: "switchers-full", reflect: !0 })
 ...
 */
const ac = (i) => i ?? M;
var lc = Object.defineProperty, cc = Object.getOwnPropertyDescriptor, At = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? cc(t, e) : t, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
  return s && n && lc(t, e, n), n;
};
const Fo = class extends k {
  constructor() {
    ...
    return y`
      ...
      >
        <input
          ...
          .type=${this.type}
          .value=${this.value}
          placeholder=${ac(this.placeholder)}
...
var uc = Object.defineProperty, hc = Object.getOwnPropertyDescriptor, Bo = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? hc(t, e) : t, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
  return s && n && uc(t, e, n), n;
};
const Uo = class extends k {
  constructor() {
...
var dc = Object.defineProperty, pc = Object.getOwnPropertyDescriptor, wi = (i, t, e, s) => {
...
const Wo = class S {
   ...
   */
  static init() {
    S.addGlobalStyles(), S.defineCustomElement("bim-button", El), S.defineCustomElement("bim-checkbox", ie), S.defineCustomElement("bim-color-input", Dt), S.defineCustomElement("bim-context-menu", _o), S.defineCustomElement("bim-dropdown", ct), S.defineCustomElement("bim-grid", pn), S.defineCustomElement("bim-icon", jl), S.defineCustomElement("bim-input", je), S.defineCustomElement("bim-label", se), S.defineCustomElement("bim-number-input", W), S.defineCustomElement("bim-option", L), S.defineCustomElement("bim-panel", oe), S.defineCustomElement("bim-panel-section", re), S.defineCustomElement("bim-selector", ae), S.defineCustomElement("bim-table", Ht), S.defineCustomElement("bim-tabs", Ft), S.defineCustomElement("bim-tab", Y), S.defineCustomElement("bim-table-cell", Po), S.defineCustomElement("bim-table-children", No), S.defineCustomElement("bim-table-group", Lo), S.defineCustomElement("bim-table-row", le), S.defineCustomElement("bim-text-input", ut), S.defineCustomElement("bim-toolbar", $i), S.defineCustomElement("bim-toolbar-group", xi), S.defineCustomElement(
      "bim-toolbar-section",
      he
    ), S.defineCustomElement("bim-viewport", Yo);
  }
  static newRandomId() {
...
let Qi = Wo;
var fc = Object.defineProperty, mc = Object.getOwnPropertyDescriptor, fn = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? mc(t, e) : t, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = (s ? r(t, e, n) : r(n)) || n);
  return s && n && fc(t, e, n), n;
};
const Go = class extends k {
  constructor() {
  ...
  updateSections() {
    const t = this.children;
    for (const e of t)
      e instanceof he && (e.labelHidden = this.vertical && !Qi.config.sectionLabelOnVerticalToolbar, e.vertical = this.vertical);
  }
  // firstUpdated() {
...
fn([
  f({ type: Boolean, attribute: "labels-hidden", reflect: !0 })
], $i.prototype, "labelsHidden", 2);
fn([
  f({ type: Boolean, reflect: !0 })
], $i.prototype, "vertical", 1);
var bc = Object.defineProperty, gc = (i, t, e, s) => {
  for (var n = void 0, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && bc(t, e, n), n;
};
const qo = class extends k {
  constructor() {
...
const vc = (i) => {
  ...
  const { components: t } = i, e = i.schemaTag ?? !0, s = i.viewDefinitionTag ?? !0, n = t.get(P.FragmentsManager), o = document.createElement("bim-table");
  o.addEventListener("cellcreated", ({ detail: a }) => {
    const { cell: l } = a;
    l.style.padding = "0.25rem 0";
  }), o.hiddenColumns = ["modelID"], o.headersHidden = !0;
  const r = [];
      ...
      return y`
       <div style="display: flex; flex: 1; gap: var(--bim-ui_size-4xs); justify-content: space-between; overflow: auto;">
        ...
        <div style="display: flex; gap: var(--bim-ui_size-4xs); align-self: flex-start; flex-shrink: 0;">
          <bim-button @click=${(x) => {
        const m = t.get(P.Hider), b = x.target;
  ...
  if (t) {
    const { components: s } = i, n = s.get(P.FragmentsManager), [, o] = e;
...
async function Ke(i, t, e, s = Xo, n = !1) {
  const o = i.get(P.IfcRelationsIndexer), r = await t.getProperties(e);
  if (!r)
    return {
...
const Cc = (i) => {
  const {
    ...
    editable: n,
    tableDefinition: o
  } = i, r = t.get(P.FragmentsManager);
  let a;
  return typeof s == "function" ? a = s(Xo) : a = s, y`<bim-table ${Q(async (u) => {
    if (!u)
      return;
    const h = u, d = [], c = [];
    for (const p in e) {
...
function Jo(i) {
  return i.map((t) => {
    ...
    return t.children && t.children.length > 0 && (e.children = Jo(t.children)), e;
  });
}
const kc = (i) => {
  const { components: t, classifications: e } = i, s = t.get(P.Classifier), n = (o) => {
    if (!o)
      return;
    const r = o;
    r.dataTransform = {
  ...
  return y`
  <div>
    ${Object.keys(e).length === 0 ? y`<bim-label label="No classifications to show"></bim-label>` : y`<bim-table ${Q(n)} headers-hidden expanded></bim-table>`}
  </div>
  `;
}, Oc = (i, t = !0) => {
  const e = $t.create(
  ...
  __proto__: null,
  classificationTree: Oc
}, Symbol.toStringTag, { value: "Module" })), Ic = ["OwnerHistory", "ObjectPlacement", "CompositionType"], ls = async (i, t, e) => {
  const n = { ...{
  ...
  for (const o of t) {
    ...
    if (r && r.type === B.IFCCLASSIFICATIONREFERENCE) {
  ...
  var r;
  const e = i.get(P.IfcRelationsIndexer), s = i.get(P.FragmentsManager), n = [], o = [];
  for (const a in t) {
      ...
      for (const d of u) {
        ...
        if (_) {
          const b = _.filter(async (E) => {
            ...
            return A ? A.type === B.IFCPROPERTYSET : !1;
          }), v = await Pc(l, b);
          v.children && p.children.push(v);
          const $ = _.filter(async (E) => {
            const A = await l.getProperties(E);
            return A ? A.type === B.IFCELEMENTQUANTITY : !1;
          }), C = await Rc(l, $);
        ...
        if (x) {
          const b = x.filter(async (E) => {
            const A = await l.getProperties(E);
            return A ? A.type === B.IFCMATERIALLAYERSETUSAGE || A.type === B.IFCMATERIALLAYERSET || A.type === B.IFCMATERIALLAYER || A.type === B.IFCMATERIAL || A.type === B.IFCMATERIALLIST : !1;
          }), v = await Nc(l, b);
          v.children && p.children.push(v);
          const $ = x.filter(
            async (E) => {
              const A = await l.getProperties(E);
              return A ? A.type === B.IFCCLASSIFICATIONREFERENCE : !1;
            }
          ), C = await Mc(
            l,
            $
...
const Dc = (i) => {
  ...
  return pt || (pt = document.createElement("bim-table"), pt.columns = [{ name: "Name", width: "12rem" }], pt.headersHidden = !0, pt.addEventListener("cellcreated", ({ detail: s }) => {
    ...
    pt.data = s, s.length !== 0 && pt.dispatchEvent(zc);
  }), y`${pt}`;
}, jc = (i) => $t.create(
  Dc,
  i
  ...
  __proto__: null,
  elementProperties: jc
}, Symbol.toStringTag, { value: "Module" })), Ki = async (i, t, e, s) => {
  var u;
  const n = [], o = i.get(P.IfcRelationsIndexer), r = await t.getProperties(e);
  if (!r)
    return n;
  const { type: a } = r, l = {
    data: {
  ...
  const n = i.get(P.IfcRelationsIndexer), o = [];
  for (const r of t) {
    let a;
    if (s)
      a = {
...
let ot;
const cs = (i, t) => {
  const e = i.get(P.FragmentsManager), { modelID: s, expressID: n, relations: o } = t.data;
  if (!(s && n))
    return null;
  ...
  ot || (ot = document.createElement("bim-table"), ot.hiddenColumns = ["modelID", "expressID", "relations"], ot.columns = ["Entity", "Name"], ot.headersHidden = !0, ot.addEventListener("cellcreated", ({ detail: a }) => {
    const { cell: l } = a;
  ...
  if (t) {
    const [, s] = e, { components: n } = i, o = n.get(P.FragmentsManager), r = n.get(P.IfcRelationsIndexer), a = () => s({ models: o.groups.values() });
  ...
  __proto__: null,
  relationsTree: Uc
}, Symbol.toStringTag, { value: "Module" })), fe = (i, t) => [...i.get(P.Grids).list.values()].find((n) => n.world === t), Wc = (i, t) => y`
  ...
  return y`
    ...
    o.lineColor = new I.Color(l).getHex(), u && (o.opacity = u / 100);
  }} color=${e} opacity=${s * 100}></bim-color-input>
  `;
}, Yc = (i, t) => y`
    <bim-color-input @input=${(s) => {
  const n = s.target, o = new I.Color(n.color);
  ...
  return y`<bim-table ${Q(async (n) => {
    var a, l, u, h, d;
    if (!n)
      return;
    const o = n;
    o.preserveStructureOnFilter = !0, o.dataTransform = {
      Value: (c, p) => {
        ...
        if (b === "Near Frustum" && x.three instanceof I.PerspectiveCamera && typeof c == "number") {
          const v = x.three;
        ...
        if (b === "Far Frustum" && x.three instanceof I.PerspectiveCamera && typeof c == "number") {
          const v = x.three;
        ...
        if (b === "Field of View" && x.three instanceof I.PerspectiveCamera && typeof c == "number") {
          const v = x.three;
        ...
        if (b === "Intensity" && typeof c == "number") {
          if (p.Light && typeof p.Light == "string") {
            ...
            return v && v instanceof I.Light ? R(v, "intensity", c, {
              slider: !0,
              min: 0,
              max: 10,
              step: 0.1
          ...
          if (p.IsAOConfig && m instanceof N.PostproductionRenderer)
            return R(
        ...
        if (b === "Ambient Oclussion" && typeof c == "boolean" && p.IsAOConfig && m instanceof N.PostproductionRenderer)
          return Xc(m, c);
        if (b === "Half Resolution" && p.IsAOConfig && m instanceof N.PostproductionRenderer && typeof c == "boolean")
          return ft(
            m.postproduction.n8ao.configuration,
            "halfRes",
            c
          );
        if (b === "Screen Space Radius" && p.IsAOConfig && m instanceof N.PostproductionRenderer && typeof c == "boolean")
          return ft(
            m.postproduction.n8ao.configuration,
            "screenSpaceRadius",
            c
          );
        if (b === "Radius" && p.IsAOConfig && m instanceof N.PostproductionRenderer && typeof c == "number")
          return R(
            m.postproduction.n8ao.configuration,
            "aoRadius",
            c,
        ...
        if (b === "Denoise Samples" && p.IsAOConfig && m instanceof N.PostproductionRenderer && typeof c == "number")
          return R(
            m.postproduction.n8ao.configuration,
            "denoiseSamples",
            c,
        ...
        if (b === "Samples" && p.IsAOConfig && m instanceof N.PostproductionRenderer && typeof c == "number")
          return R(
            m.postproduction.n8ao.configuration,
            "aoSamples",
            c,
        ...
        if (b === "Denoise Radius" && p.IsAOConfig && m instanceof N.PostproductionRenderer && typeof c == "number")
          return R(
            m.postproduction.n8ao.configuration,
            "denoiseRadius",
            c,
        ...
        if (b === "Distance Falloff" && p.IsAOConfig && m instanceof N.PostproductionRenderer && typeof c == "number")
          return R(
            m.postproduction.n8ao.configuration,
            "distanceFalloff",
            c,
        ...
        if (b === "Directional Light" && p.Light && typeof p.Light == "string" && typeof c == "boolean") {
          ...
          return v && v instanceof I.Light ? ft(v, "visible", c) : c;
        }
        ...
        if (b === "Position" && p.Light && typeof p.Light == "string" && typeof c == "string") {
          ...
          return y`
            <div style="display: flex; gap: 0.25rem; width: 100%; flex-wrap: wrap">${A}${j}${O}</div>
          `;
        }
        return b === "Custom Effects" && p.IsCEConfig && m instanceof N.PostproductionRenderer && typeof c == "boolean" ? Qc(m, c) : b === "Color" && p.IsOutlineConfig && m instanceof N.PostproductionRenderer && typeof c == "string" ? qc(m, c) : b === "Tolerance" && p.IsOutlineConfig && m instanceof N.PostproductionRenderer && typeof c == "number" ? R(
          m.postproduction.customEffects,
          "tolerance",
          c,
          { slider: !0, min: 0, max: 6, step: 0.01 }
        ) : b === "Outline" && p.IsOutlineConfig && m instanceof N.PostproductionRenderer && typeof c == "boolean" ? ft(
          m.postproduction.customEffects,
          "outlineEnabled",
          c
        ) : b === "Gloss" && p.IsGlossConfig && m instanceof N.PostproductionRenderer && typeof c == "boolean" ? ft(
          m.postproduction.customEffects,
          "glossEnabled",
          c
        ) : b === "Min" && p.IsGlossConfig && m instanceof N.PostproductionRenderer && typeof c == "number" ? R(
          m.postproduction.customEffects,
          "minGloss",
          c,
          { slider: !0, min: -0.5, max: 0.5, step: 0.01 }
        ) : b === "Max" && p.IsGlossConfig && m instanceof N.PostproductionRenderer && typeof c == "number" ? R(
          m.postproduction.customEffects,
          "maxGloss",
          c,
          { slider: !0, min: -0.5, max: 0.5, step: 0.01 }
        ) : b === "Exponent" && p.IsGlossConfig && m instanceof N.PostproductionRenderer && typeof c == "number" ? R(
          m.postproduction.customEffects,
          "glossExponent",
          c,
          { slider: !0, min: 0, max: 5, step: 0.01 }
        ) : b === "Gamma Correction" && p.IsGammaConfig && m instanceof N.PostproductionRenderer && typeof c == "boolean" ? Jc(m, c) : c;
      }
    ...
    for (const [, c] of e.list) {
      const { scene: p, camera: g, renderer: w } = c, _ = fe(t, c), x = {
        data: {
      ...
      if (g.three instanceof I.PerspectiveCamera) {
        const m = {
          data: {
      ...
      if (w instanceof N.PostproductionRenderer) {
  ...
  if (t) {
    const [s] = e, n = () => e[1](), { components: o } = i, r = o.get(P.Worlds);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ze = globalThis, mn = Ze.ShadowRoot && (Ze.ShadyCSS === void 0 || Ze.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, bn = Symbol(), us = /* @__PURE__ */ new WeakMap();
let Qo = class {
  constructor(t, e, s) {
    if (this._$cssResult$ = !0, s !== bn)
      throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
...
const eu = (i) => new Qo(typeof i == "string" ? i : i + "", void 0, bn), Ko = (i, ...t) => {
  const e = i.length === 1 ? i[0] : t.reduce((s, n, o) => s + ((r) => {
    if (r._$cssResult$ === !0)
      return r.cssText;
    if (typeof r == "number")
...
}, hs = mn ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const s of t.cssRules)
    e += s.cssText;
  return eu(e);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: nu, defineProperty: su, getOwnPropertyDescriptor: ou, getOwnPropertyNames: ru, getOwnPropertySymbols: au, getPrototypeOf: lu } = Object, vt = globalThis, ds = vt.trustedTypes, cu = ds ? ds.emptyScript : "", Ri = vt.reactiveElementPolyfillSupport, _e = (i, t) => i, ui = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? cu : null;
      break;
  ...
  return e;
} }, gn = (i, t) => !nu(i, t), ps = { attribute: !0, type: String, converter: ui, reflect: !1, hasChanged: gn };
...
class Ut extends HTMLElement {
  ...
  static createProperty(t, e = ps) {
    if (e.state && (e.attribute = !1), this._$Ei(), this.elementProperties.set(t, e), !e.noAccessor) {
      const s = Symbol(), n = this.getPropertyDescriptor(t, s, e);
      n !== void 0 && su(this.prototype, t, n);
    }
  }
  static getPropertyDescriptor(t, e, s) {
    const { get: n, set: o } = ou(this.prototype, t) ?? { get() {
      return this[e];
    }, set(r) {
      this[e] = r;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(_e("properties"))) {
      const e = this.properties, s = [...ru(e), ...au(e)];
      for (const n of s)
        this.createProperty(n, e[n]);
    }
    const t = this[Symbol.metadata];
  ...
  createRenderRoot() {
    const t = this.shadowRoot ?? this.attachShadow(this.constructor.shadowRootOptions);
    return iu(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
    var t;
    this.renderRoot ?? (this.renderRoot = this.createRenderRoot()), this.enableUpdating(!0), (t = this._$EO) == null || t.forEach((e) => {
  ...
  _$EC(t, e) {
    ...
    if (n !== void 0 && s.reflect === !0) {
      const r = (((o = s.converter) == null ? void 0 : o.toAttribute) !== void 0 ? s.converter : ui).toAttribute(e, s.type);
  ...
  _$AK(t, e) {
    ...
    if (n !== void 0 && this._$Em !== n) {
      const r = s.getPropertyOptions(n), a = typeof r.converter == "function" ? { fromAttribute: r.converter } : ((o = r.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? r.converter : ui;
      this._$Em = n, this[n] = a.fromAttribute(e, r.type), this._$Em = null;
    }
  }
  requestUpdate(t, e, s) {
    if (t !== void 0) {
      if (s ?? (s = this.constructor.getPropertyOptions(t)), !(s.hasChanged ?? gn)(this[t], e))
        return;
      this.P(t, e, s);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$ET());
...
Ut.elementStyles = [], Ut.shadowRootOptions = { mode: "open" }, Ut[_e("elementProperties")] = /* @__PURE__ */ new Map(), Ut[_e("finalized")] = /* @__PURE__ */ new Map(), Ri == null || Ri({ ReactiveElement: Ut }), (vt.reactiveElementVersions ?? (vt.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const xe = globalThis, hi = xe.trustedTypes, fs = hi ? hi.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, Zo = "$lit$", bt = `lit$${Math.random().toFixed(9).slice(2)}$`, tr = "?" + bt, uu = `<${tr}>`, zt = document, Oe = () => zt.createComment(""), Te = (i) => i === null || typeof i != "object" && typeof i != "function", er = Array.isArray, hu = (i) => er(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Ni = `[ 	
\f\r]`, me = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ms = /-->/g, bs = />/g, It = RegExp(`>|${Ni}(?:([^\\s"'>=/]+)(${Ni}*=${Ni}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), gs = /'/g, vs = /"/g, ir = /^(?:script|style|textarea|title)$/i, du = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), nr = du(1), Zt = Symbol.for("lit-noChange"), D = Symbol.for("lit-nothing"), ys = /* @__PURE__ */ new WeakMap(), Rt = zt.createTreeWalker(zt, 129);
function sr(i, t) {
  if (!Array.isArray(i) || !i.hasOwnProperty("raw"))
    throw Error("invalid template strings array");
...
const pu = (i, t) => {
  const e = i.length - 1, s = [];
  let n, o = t === 2 ? "<svg>" : "", r = me;
  for (let a = 0; a < e; a++) {
    const l = i[a];
    let u, h, d = -1, c = 0;
    for (; c < l.length && (r.lastIndex = c, h = r.exec(l), h !== null); )
      c = r.lastIndex, r === me ? h[1] === "!--" ? r = ms : h[1] !== void 0 ? r = bs : h[2] !== void 0 ? (ir.test(h[2]) && (n = RegExp("</" + h[2], "g")), r = It) : h[3] !== void 0 && (r = It) : r === It ? h[0] === ">" ? (r = n ?? me, d = -1) : h[1] === void 0 ? d = -2 : (d = r.lastIndex - h[2].length, u = h[1], r = h[3] === void 0 ? It : h[3] === '"' ? vs : gs) : r === vs || r === gs ? r = It : r === ms || r === bs ? r = me : (r = It, n = void 0);
    const p = r === It && i[a + 1].startsWith("/>") ? " " : "";
    o += r === me ? l + uu : d >= 0 ? (s.push(u), l.slice(0, d) + Zo + l.slice(d) + bt + p) : l + bt + (d === -2 ? a : p);
  }
  return [sr(i, o + (i[e] || "<?>") + (t === 2 ? "</svg>" : "")), s];
};
class Ie {
  constructor({ strings: t, _$litType$: e }, s) {
    let n;
    this.parts = [];
    let o = 0, r = 0;
    const a = t.length - 1, l = this.parts, [u, h] = pu(t, e);
    ...
    for (; (n = Rt.nextNode()) !== null && l.length < a; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes())
          for (const d of n.getAttributeNames())
            if (d.endsWith(Zo)) {
              const c = h[r++], p = n.getAttribute(d).split(bt), g = /([.?@])?(.*)/.exec(c);
              l.push({ type: 1, index: o, name: g[2], strings: p, ctor: g[1] === "." ? mu : g[1] === "?" ? bu : g[1] === "@" ? gu : Ci }), n.removeAttribute(d);
            } else
              d.startsWith(bt) && (l.push({ type: 6, index: o }), n.removeAttribute(d));
        if (ir.test(n.tagName)) {
          const d = n.textContent.split(bt), c = d.length - 1;
          if (c > 0) {
            n.textContent = hi ? hi.emptyScript : "";
            for (let p = 0; p < c; p++)
              n.append(d[p], Oe()), Rt.nextNode(), l.push({ type: 2, index: ++o });
            n.append(d[c], Oe());
          }
        }
      } else if (n.nodeType === 8)
        if (n.data === tr)
          ...
          for (; (d = n.data.indexOf(bt, d + 1)) !== -1; )
            l.push({ type: 7, index: o }), d += bt.length - 1;
        }
      o++;
    }
  }
...
function te(i, t, e = i, s) {
  var r, a;
  if (t === Zt)
    return t;
  let n = s !== void 0 ? (r = e._$Co) == null ? void 0 : r[s] : e._$Cl;
  const o = Te(t) ? void 0 : t._$litDirective$;
  return (n == null ? void 0 : n.constructor) !== o && ((a = n == null ? void 0 : n._$AO) == null || a.call(n, !1), o === void 0 ? n = void 0 : (n = new o(i), n._$AT(i, e, s)), s !== void 0 ? (e._$Co ?? (e._$Co = []))[s] = n : e._$Cl = n), n !== void 0 && (t = te(i, n._$AS(i, t.values), n, s)), t;
}
class fu {
  constructor(t, e) {
    this._$AV = [], this._$AN = void 0, this._$AD = t, this._$AM = e;
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (r === l.index) {
        let u;
        l.type === 2 ? u = new We(o, o.nextSibling, this, t) : l.type === 1 ? u = new l.ctor(o, l.name, l.strings, this, t) : l.type === 6 && (u = new vu(o, this, t)), this._$AV.push(u), l = s[++a];
      }
...
class We {
  ...
  _$AI(t, e = this) {
    t = te(this, t, e), Te(t) ? t === D || t == null || t === "" ? (this._$AH !== D && this._$AR(), this._$AH = D) : t !== this._$AH && t !== Zt && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : hu(t) ? this.k(t) : this._(t);
  }
  S(t) {
    return this._$AA.parentNode.insertBefore(t, this._$AB);
  }
  ...
  _(t) {
    this._$AH !== D && Te(this._$AH) ? this._$AA.nextSibling.data = t : this.T(zt.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var o;
    const { values: e, _$litType$: s } = t, n = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = Ie.createElement(sr(s.h, s.h[0]), this.options)), s);
    if (((o = this._$AH) == null ? void 0 : o._$AD) === n)
      this._$AH.p(e);
    else {
      const r = new fu(n, this), a = r.u(this.options);
  ...
  k(t) {
    ...
    let s, n = 0;
    for (const o of t)
      n === e.length ? e.push(s = new We(this.S(Oe()), this.S(Oe()), this, this.options)) : s = e[n], s._$AI(o), n++;
    n < e.length && (this._$AR(s && s._$AB.nextSibling, n), e.length = n);
  }
  _$AR(t = this._$AA.nextSibling, e) {
    var s;
...
class Ci {
  ...
  _$AI(t, e = this, s, n) {
    ...
    let r = !1;
    if (o === void 0)
      t = te(this, t, e, 0), r = !Te(t) || t !== this._$AH && t !== Zt, r && (this._$AH = t);
    else {
      const a = t;
      let l, u;
      for (t = o[0], l = 0; l < o.length - 1; l++)
        u = te(this, a[s + l], e, l), u === Zt && (u = this._$AH[l]), r || (r = !Te(u) || u !== this._$AH[l]), u === D ? t = D : t !== D && (t += (u ?? "") + o[l + 1]), this._$AH[l] = u;
    }
    r && !n && this.j(t);
  }
  j(t) {
...
const Mi = xe.litHtmlPolyfillSupport;
Mi == null || Mi(Ie, We), (xe.litHtmlVersions ?? (xe.litHtmlVersions = [])).push("3.1.4");
const yu = (i, t, e) => {
  const s = (e == null ? void 0 : e.renderBefore) ?? t;
  let n = s._$litPart$;
  if (n === void 0) {
    const o = (e == null ? void 0 : e.renderBefore) ?? null;
    s._$litPart$ = n = new We(t.insertBefore(Oe(), o), o, void 0, e ?? {});
  }
  return n._$AI(i), n;
};
/**
...
class Wt extends Ut {
  ...
  update(t) {
    const e = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = yu(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t;
    super.connectedCallback(), (t = this._$Do) == null || t.setConnected(!0);
...
var _s;
Wt._$litElement$ = !0, Wt.finalized = !0, (_s = globalThis.litElementHydrateSupport) == null || _s.call(globalThis, { LitElement: Wt });
const Li = globalThis.litElementPolyfillSupport;
Li == null || Li({ LitElement: Wt });
(globalThis.litElementVersions ?? (globalThis.litElementVersions = [])).push("4.0.6");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const _u = { attribute: !0, type: String, converter: ui, reflect: !1, hasChanged: gn }, xu = (i = _u, t, e) => {
  const { kind: s, metadata: n } = e;
  let o = globalThis.litPropertyMetadata.get(n);
  if (o === void 0 && globalThis.litPropertyMetadata.set(n, o = /* @__PURE__ */ new Map()), o.set(e.name, i), s === "accessor") {
    const { name: r } = e;
...
function tt(i) {
  return (t, e) => typeof e == "object" ? xu(i, t, e) : ((s, n, o) => {
    const r = n.hasOwnProperty(o);
    return n.constructor.createProperty(o, r ? { ...s, wrapped: !0 } : s), r ? Object.getOwnPropertyDescriptor(n, o) : void 0;
  })(i, t, e);
}
...
class $u extends dr {
  constructor(t = document.createElement("div")) {
    super(), this.isCSS2DObject = !0, this.element = t, this.element.style.position = "absolute", this.element.style.userSelect = "none", this.element.setAttribute("draggable", !1), this.center = new pr(0.5, 0.5), this.addEventListener("removed", function() {
...
class Cu {
  ...
  regenerate() {
    ...
    const { planes: s } = this._frustum, n = s[0].constant * -s[0].normal.x, o = s[1].constant * -s[1].normal.x, r = s[2].constant * -s[2].normal.y, a = s[3].constant * -s[3].normal.y, l = Math.abs(n - o), u = Math.abs(a - r), { clientWidth: h, clientHeight: d } = this._container, c = Math.max(h, d), g = Math.max(l, u) / c, w = Math.ceil(Math.log10(l / this.scaleX)), _ = Math.ceil(Math.log10(u / this.scaleY)), x = 10 ** (w - 2) * this.scaleX, m = 10 ** (_ - 2) * this.scaleY, b = x * this.gridsFactor, v = m * this.gridsFactor, $ = Math.ceil(u / v), C = Math.ceil(l / b), E = Math.ceil(u / m), A = Math.ceil(l / x), j = x * Math.ceil(o / x), O = m * Math.ceil(r / m), G = b * Math.ceil(o / b), kt = v * Math.ceil(r / v), ht = [...this.numbers.children];
    for (const F of ht)
      F.removeFromParent();
    this.numbers.children = [];
    const U = [], dt = 9 * g, H = 1e4, et = Math.round(Math.abs(G / this.scaleX) * H) / H, q = (C - 1) * b, it = Math.round(Math.abs((G + q) / this.scaleX) * H) / H, or = Math.max(et, it).toString().length * dt;
    let Ei = Math.ceil(or / b) * b;
    for (let F = 0; F < C; F++) {
      let z = G + F * b;
      U.push(z, a, 0, z, r, 0);
      const de = z / this.scaleX;
      z = Math.round(z * H) / H, Ei = Math.round(Ei * H) / H;
      const Ge = z % Ei;
      if (!(b < 1 || v < 1) && Math.abs(Ge) > 0.01)
        continue;
      const ur = this.newNumber(de), hr = 12 * g;
      ur.position.set(z, r + hr, 0);
    }
    for (let F = 0; F < $; F++) {
      const z = kt + F * v;
      U.push(o, z, 0, n, z, 0);
      const de = this.newNumber(z / this.scaleY);
      let Ge = 12;
      de.element.textContent && (Ge += 4 * de.element.textContent.length);
      const wn = Ge * g;
      de.position.set(o + wn, z, 0);
    }
    const Ai = [];
    for (let F = 0; F < A; F++) {
      const z = j + F * x;
    ...
    const rr = new I.BufferAttribute(new Float32Array(U), 3), ar = new I.BufferAttribute(new Float32Array(Ai), 3), { main: lr, secondary: cr } = this.grids;
    lr.geometry.setAttribute("position", rr), cr.geometry.setAttribute("position", ar);
  }
  newNumber(t) {
...
var Eu = Object.defineProperty, Au = Object.getOwnPropertyDescriptor, vn = (i, t, e, s) => {
  for (var n = Au(t, e), o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && Eu(t, e, n), n;
};
const yn = class yn extends Wt {
  constructor() {
  ...
  set components(t) {
    ...
    s.camera = n;
    const o = new Cu(n.threeOrtho, this);
...
let ee = yn;
vn([
  tt({ type: String, attribute: "grid-color", reflect: !0 })
], ee.prototype, "gridColor");
vn([
  tt({ type: Number, attribute: "grid-scale-x", reflect: !0 })
], ee.prototype, "gridScaleX");
vn([
  tt({ type: Number, attribute: "grid-scale-y", reflect: !0 })
], ee.prototype, "gridScaleY");
var Su = Object.defineProperty, St = (i, t, e, s) => {
  for (var n = void 0, o = i.length - 1, r; o >= 0; o--)
    (r = i[o]) && (n = r(t, e, n) || n);
  return n && Su(t, e, n), n;
};
const _n = class _n extends Wt {
  constructor() {
...
let K = _n;
St([
  tt({ type: Number, reflect: !0 })
], K.prototype, "size");
St([
  tt({ type: String, attribute: "right-text", reflect: !0 })
], K.prototype, "rightText");
St([
  tt({ type: String, attribute: "left-text", reflect: !0 })
], K.prototype, "leftText");
St([
  tt({ type: String, attribute: "top-text", reflect: !0 })
], K.prototype, "topText");
St([
  tt({ type: String, attribute: "bottom-text", reflect: !0 })
], K.prototype, "bottomText");
St([
  tt({ type: String, attribute: "front-text", reflect: !0 })
], K.prototype, "frontText");
St([
  tt({ type: String, attribute: "back-text", reflect: !0 })
...
class rh {
   ...
   */
  static init() {
    Qi.defineCustomElement("bim-view-cube", K), Qi.defineCustomElement("bim-world-2d", ee);
  }
}
export {
  rh as Manager,
