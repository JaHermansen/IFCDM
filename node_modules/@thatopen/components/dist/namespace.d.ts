...
export declare class IfcRelationsIndexer extends Component implements Disposable {
    ...
    getAttributeIndex(inverseAttribute: InverseAttribute): number | null;
    /**
     ...
     */
    getEntityRelations(model: FragmentsGroup | string, expressID: number, relationName: InverseAttribute): number[] | null;
    /**
     ...
     */
    readonly onEntitiesRelated: Event<{
...
export declare class IfcPropertiesManager extends Component implements Disposable {
    ...
    newPset(model: FragmentsGroup, name: string, description?: string): Promise<{
        ...
        rel: WEBIFC.IFC4X3.IfcRelDefinesByProperties | WEBIFC.IFC2X3.IfcRelDefinesByProperties | WEBIFC.IFC4.IfcRelDefinesByProperties;
    }>;
    /**
