...
var He = (a, t, s) => t in a ? $e(a, t, { enumerable: true, configurable: true, writable: true, value: s }) : a[t] = s;
var P = (a, t, s) => (He(a, typeof t != "symbol" ? t + "" : t, s), s);
var le = class extends InstancedMesh {
  /**
  ...
  exportData() {
    ...
    if (Array.isArray(this.material))
      for (const f of this.material) {
        const l = f.opacity, b = f.transparent ? 1 : 0, h = new Color(f.color).toArray();
        o.push(l, b, ...h);
      }
...
var Vs = 6 * 4 + 4 + 4;
var Ts = 65535;
var ti = Math.pow(2, -24);
var Ls = Symbol("SKIP_GENERATION");
function si(a) {
...
var lt = 32;
var ai = (a, t) => a.candidate - t.candidate;
var wt = new Array(lt).fill().map(() => ({
  count: 0,
...
function ui(a, t) {
  ...
  function w(m, g, A, F = null, x = 0) {
    if (!b && x >= i && (b = true, n && (console.warn(`MeshBVH: Max depth of ${i} reached when generating BVH. Consider increasing maxDepth.`), console.warn(s))), A <= o || x >= i)
...
var pi = function() {
  const a = new Vector3(), t = new Vector3(), s = new Vector3();
...
var oe = function() {
  const a = new Vector2(), t = new Vector3(), s = new Vector3();
  return function(i, n, o, r) {
    ...
    if (c >= 0 && c <= 1 && f >= 0 && f <= 1) {
      ...
      f < 0 ? n.at(0, r) : n.at(1, r), i.closestPointToPoint(r, true, o);
      return;
    } else if (f >= 0 && f <= 1) {
      c < 0 ? i.at(0, o) : i.at(1, o), n.closestPointToPoint(o, true, r);
      return;
    } else {
      let l;
      ...
      const h = t, d = s;
      if (i.closestPointToPoint(b, true, t), n.closestPointToPoint(l, true, s), h.distanceToSquared(b) <= d.distanceToSquared(l)) {
        o.copy(h), r.copy(b);
        return;
      } else {
        o.copy(l), r.copy(d);
...
var mi = function() {
  const a = new Vector3(), t = new Vector3(), s = new Plane(), e = new Line3();
  return function(n, o) {
    const { radius: r, center: c } = n, { a: f, b: l, c: b } = o;
    if (e.start = f, e.end = l, e.closestPointToPoint(c, true, a).distanceTo(c) <= r || (e.start = f, e.end = b, e.closestPointToPoint(c, true, a).distanceTo(c) <= r) || (e.start = l, e.end = b, e.closestPointToPoint(c, true, a).distanceTo(c) <= r))
      return true;
...
var rt = class extends Triangle {
  constructor(...t) {
    super(...t), this.isExtendedTriangle = true, this.satAxes = new Array(4).fill().map(() => new Vector3()), this.satBounds = new Array(4).fill().map(() => new pt()), this.points = [this.a, this.b, this.c], this.sphere = new Sphere(), this.plane = new Plane(), this.needsUpdate = true;
  }
  intersectsSphere(t) {
    return mi(t, this);
  }
  update() {
    ...
    const d = n[3], _ = o[3];
    d.subVectors(e, t), _.setFromPoints(d, i), this.sphere.setFromPoints(this.points), this.plane.setFromNormalAndCoplanarPoint(r, t), this.needsUpdate = false;
  }
};
rt.prototype.closestPointToSegment = function() {
  const a = new Vector3(), t = new Vector3(), s = new Line3();
...
rt.prototype.intersectsTriangle = function() {
  const a = new rt(), t = new Array(3), s = new Array(3), e = new pt(), i = new pt(), n = new Vector3(), o = new Vector3(), r = new Vector3(), c = new Vector3(), f = new Vector3(), l = new Line3(), b = new Line3(), h = new Line3(), d = new Vector3();
  function _(I, y, u) {
    const p = I.points;
    let w = 0, m = -1;
    for (let g = 0; g < 3; g++) {
  ...
  return function(y, u = null, p = false) {
    ...
    if (Math.abs(w.normal.dot(m.normal)) > 1 - 1e-10) {
      ...
      return u && (p || console.warn("ExtendedTriangle.intersectsTriangle: Triangles are coplanar which does not support an output edge. Setting edge to 0, 0, 0."), u.start.set(0, 0, 0), u.end.set(0, 0, 0)), true;
    } else {
      const g = _(this, m, b);
      if (g === 1 && y.containsPoint(b.end))
        return u && (u.start.copy(b.end), u.end.copy(b.end)), true;
      if (g !== 2)
        return false;
      const A = _(y, w, h);
      if (A === 1 && this.containsPoint(h.end))
        return u && (u.start.copy(h.end), u.end.copy(h.end)), true;
      if (A !== 2)
        return false;
      ...
      return F !== v && C !== x && S === V ? false : (u && (f.subVectors(b.start, h.start), f.dot(r) > 0 ? u.start.copy(b.start) : u.start.copy(h.start), f.subVectors(b.end, h.end), f.dot(r) < 0 ? u.end.copy(b.end) : u.end.copy(h.end)), true);
    }
  };
}();
...
rt.prototype.distanceToTriangle = function() {
  const a = new Vector3(), t = new Vector3(), s = ["a", "b", "c"], e = new Line3(), i = new Line3();
...
var X = class {
  constructor(t, s, e) {
    this.isOrientedBox = true, this.min = new Vector3(), this.max = new Vector3(), this.matrix = new Matrix4(), this.invMatrix = new Matrix4(), this.points = new Array(8).fill().map(() => new Vector3()), this.satAxes = new Array(3).fill().map(() => new Vector3()), this.satBounds = new Array(3).fill().map(() => new pt()), this.alignedSatBounds = new Array(3).fill().map(() => new pt()), this.needsUpdate = false, t && this.min.copy(t), s && this.max.copy(s), e && this.matrix.copy(e);
  }
  set(t, s, e) {
    this.min.copy(t), this.max.copy(s), this.matrix.copy(e), this.needsUpdate = true;
  }
  copy(t) {
...
X.prototype.update = /* @__PURE__ */ function() {
  return function() {
    ...
    c[0].setFromPointsField(i, "x"), c[1].setFromPointsField(i, "y"), c[2].setFromPointsField(i, "z"), this.invMatrix.copy(this.matrix).invert(), this.needsUpdate = false;
  };
}();
...
X.prototype.intersectsTriangle = function() {
  const a = new rt(), t = new Array(3), s = new pt(), e = new pt(), i = new Vector3();
  return function(o) {
...
X.prototype.distanceToBox = function() {
  const a = ["x", "y", "z"], t = new Array(12).fill().map(() => new Line3()), s = new Array(12).fill().map(() => new Line3()), e = new Vector3(), i = new Vector3();
...
function Xs(a, t, s, e, i = null, n = 0, o = 0) {
  ...
  if (J(l, c)) {
    ...
    return R(a, r, vt), e(h, d, false, o, n + a, vt);
  } else {
    let v = function(V) {
...
function Ai(a, t, s, e, i, n) {
  let o;
  return n === BackSide ? o = a.intersectTriangle(e, s, t, true, i) : o = a.intersectTriangle(t, s, e, n !== DoubleSide, i), o === null ? null : {
...
function vi(a, t, s, e, i, n, o, r, c) {
  ...
  if (f) {
    e && (ds.fromBufferAttribute(e, n), us.fromBufferAttribute(e, o), _s.fromBufferAttribute(e, r), f.uv = Triangle.getInterpolation(ps, Gt, Rt, Nt, ds, us, _s, new Vector2())), i && (ds.fromBufferAttribute(i, n), us.fromBufferAttribute(i, o), _s.fromBufferAttribute(i, r), f.uv1 = Triangle.getInterpolation(ps, Gt, Rt, Nt, ds, us, _s, new Vector2())), s && (pe.fromBufferAttribute(s, n), me.fromBufferAttribute(s, o), ye.fromBufferAttribute(s, r), f.normal = Triangle.getInterpolation(ps, Gt, Rt, Nt, pe, me, ye, new Vector3()), f.normal.dot(a.direction) > 0 && f.normal.multiplyScalar(-1));
    const l = {
      a: n,
      b: o,
      c: r,
    ...
    Triangle.getNormal(Gt, Rt, Nt, l.normal), f.face = l, f.faceIndex = n;
  }
  return f;
}
...
function Ci(a, t, s, e, i, n, o) {
  ...
  for (let l = a, b = t + a; l < b; l++) {
    let h;
    if (h = l, q(o, h * 3, c, f), o.needsUpdate = true, e(o, h, i, n))
      return true;
  }
  return false;
}
function Mi(a, t = null) {
  ...
  function b(h, d, _ = false) {
    ...
    if (r[I + 15] === Ts) {
      ...
      return c[h + 0] !== w || c[h + 1] !== m || c[h + 2] !== g || c[h + 3] !== A || c[h + 4] !== F || c[h + 5] !== x ? (c[h + 0] = w, c[h + 1] = m, c[h + 2] = g, c[h + 3] = A, c[h + 4] = F, c[h + 5] = x, true) : false;
    } else {
      const u = h + 8, p = o[h + 6], w = u + d, m = p + d;
      let g = _, A = false, F = false;
      t ? g || (A = t.has(w), F = t.has(m), g = !A && !F) : (A = true, F = true);
      const x = g || A, C = g || F;
      let v = false;
      x && (v = b(u, d, g));
      let S = false;
...
function Ti(a, t, s, e, i, n, o) {
  ...
  for (let l = a, b = t + a; l < b; l++) {
    let h;
    if (h = s.resolveTriangleIndex(l), q(o, h * 3, c, f), o.needsUpdate = true, e(o, h, i, n))
      return true;
  }
  return false;
}
...
function Js(a, t, s, e, i = null) {
  ...
  if (i === null && (s.boundingBox || s.computeBoundingBox(), xe.set(s.boundingBox.min, s.boundingBox.max, e), i = xe), J(c, o)) {
    ...
    if (ts.copy(e).invert(), s.boundsTree)
      return R(a, n, ys), ys.matrix.copy(ts), ys.needsUpdate = true, s.boundsTree.shapecast({
        intersectsBounds: (p) => ys.intersectsBox(p),
        intersectsTriangle: (p) => {
          p.a.applyMatrix4(e), p.b.applyMatrix4(e), p.c.applyMatrix4(e), p.needsUpdate = true;
          for (let w = I * 3, m = (y + I) * 3; w < m; w += 3)
            if (q(qt, w, b, h), qt.needsUpdate = true, p.intersectsTriangle(qt))
              return true;
          return false;
        }
      });
    for (let u = I * 3, p = (y + I) * 3; u < p; u += 3) {
      q(kt, u, b, h), kt.a.applyMatrix4(ts), kt.b.applyMatrix4(ts), kt.c.applyMatrix4(ts), kt.needsUpdate = true;
      for (let w = 0, m = d.count; w < m; w += 3)
        if (q(qt, w, d, _), qt.needsUpdate = true, kt.intersectsTriangle(qt))
          return true;
    }
  } else {
    const l = a + 8, b = r[a + 6];
...
function Ri(a, t, s, e = {}, i = {}, n = 0, o = 1 / 0) {
  t.boundingBox || t.computeBoundingBox(), Gs.set(t.boundingBox.min, t.boundingBox.max, s), Gs.needsUpdate = true;
  ...
  return gs.copy(s).invert(), ss.matrix.copy(gs), a.shapecast(
    {
      ...
      intersectsBounds: (g, A, F) => F < p && F < o ? (A && (ss.min.copy(g.min), ss.max.copy(g.max), ss.needsUpdate = true), true) : false,
      intersectsRange: (g, A) => {
        if (t.boundsTree)
          return t.boundsTree.shapecast({
            ...
            intersectsRange: (x, C) => {
              for (let v = x, S = x + C; v < S; v++) {
                q(d, 3 * v, b, l), d.a.applyMatrix4(s), d.b.applyMatrix4(s), d.c.applyMatrix4(s), d.needsUpdate = true;
                for (let V = g, M = g + A; V < M; V++) {
                  q(h, 3 * V, f, c), h.needsUpdate = true;
          ...
          });
        {
          ...
          for (let x = 0, C = F; x < C; x++) {
            q(d, 3 * x, b, l), d.a.applyMatrix4(s), d.b.applyMatrix4(s), d.c.applyMatrix4(s), d.needsUpdate = true;
...
function te(a, t, s, e, i = null) {
  ...
  if (i === null && (s.boundingBox || s.computeBoundingBox(), Ve.set(s.boundingBox.min, s.boundingBox.max, e), i = Ve), J(c, o)) {
    ...
    if (es.copy(e).invert(), s.boundsTree)
      return R(a, n, Is), Is.matrix.copy(es), Is.needsUpdate = true, s.boundsTree.shapecast({
        intersectsBounds: (p) => Is.intersectsBox(p),
        intersectsTriangle: (p) => {
          p.a.applyMatrix4(e), p.b.applyMatrix4(e), p.c.applyMatrix4(e), p.needsUpdate = true;
          for (let w = I, m = y + I; w < m; w++)
            if (q(jt, 3 * t.resolveTriangleIndex(w), b, h), jt.needsUpdate = true, p.intersectsTriangle(jt))
              return true;
          return false;
        }
      });
    for (let u = I, p = y + I; u < p; u++) {
      ...
      q(Kt, 3 * w, b, h), Kt.a.applyMatrix4(es), Kt.b.applyMatrix4(es), Kt.c.applyMatrix4(es), Kt.needsUpdate = true;
      for (let m = 0, g = d.count; m < g; m += 3)
        if (q(jt, m, d, _), jt.needsUpdate = true, Kt.intersectsTriangle(jt))
          return true;
    }
  } else {
    const l = a + 8, b = r[a + 6];
...
function Zi(a, t, s, e = {}, i = {}, n = 0, o = 1 / 0) {
  t.boundingBox || t.computeBoundingBox(), Rs.set(t.boundingBox.min, t.boundingBox.max, s), Rs.needsUpdate = true;
  const r = a.geometry, c = r.attributes.position, f = r.index, l = t.attributes.position, b = t.index, h = tt.getPrimitive(), d = tt.getPrimitive();
  ...
  return xs.copy(s).invert(), is.matrix.copy(xs), a.shapecast(
    {
      ...
      intersectsBounds: (g, A, F) => F < p && F < o ? (A && (is.min.copy(g.min), is.max.copy(g.max), is.needsUpdate = true), true) : false,
      intersectsRange: (g, A) => {
        if (t.boundsTree) {
            ...
            intersectsRange: (x, C) => {
              for (let v = x, S = x + C; v < S; v++) {
                ...
                for (let M = g, T = g + A; M < T; M++) {
                  ...
                  q(h, 3 * D, f, c), h.needsUpdate = true;
...
var os = new G.constructor();
var Ms = new G.constructor();
var It = new re(() => new Box3());
var $t = new Box3();
var Ht = new Box3();
var Ns = new Box3();
var ks = new Box3();
...
function Wi(a, t, s, e) {
  ...
  let o, r = 0, c = 0;
  const f = new Matrix4().copy(s).invert();
...
function nt(a, t, s, e, i, n = 0, o = 0, r = 0, c = 0, f = null, l = false) {
  let b, h;
...
var ce = class _ce {
  ...
  static deserialize(t, s, e = {}) {
    ...
    const { index: i, roots: n, indirectBuffer: o } = t, r = new _ce(s, { ...e, [Ls]: true });
    if (r._roots = n, r._indirectBuffer = o || null, e.setIndex) {
      const c = s.getIndex();
      if (c === null) {
        const f = new BufferAttribute(t.index, 1, false);
        s.setIndex(f);
      } else
        c.array !== i && (c.array.set(i), c.needsUpdate = true);
    }
    return r;
  }
  get indirect() {
  ...
  constructor(t, s = {}) {
    ...
    this.geometry = t, this._roots = null, this._indirectBuffer = null, s[Ls] || (_i(this, s), !t.boundingBox && s.setBoundingBox && (t.boundingBox = this.getBoundingBox(new Box3())));
  ...
  shapecast(t) {
    ...
    if (o && r) {
      const b = o;
      o = (h, d, _, I, y) => b(h, d, _, I, y) ? true : e(h, d, this, r, _, I, s);
    } else
    ...
    if (n) {
      const _ = (I, y, u, p, w, m, g, A) => {
        for (let F = u, x = u + p; F < x; F++) {
          d(F), l.a.applyMatrix4(s), l.b.applyMatrix4(s), l.c.applyMatrix4(s), l.needsUpdate = true;
          for (let C = I, v = I + y; C < v; C++)
            if (f(C), o.needsUpdate = true, n(o, l, C, F, w, m, g, A))
              return true;
        }
        return false;
      };
      if (i) {
        ...
        i = function(y, u, p, w, m, g, A, F) {
          return I(y, u, p, w, m, g, A, F) ? true : _(y, u, p, w, m, g, A, F);
        };
      } else
        i = _;
    }
  ...
  intersectsBox(t, s) {
    return As.set(t.min, t.max, s), As.needsUpdate = true, this.shapecast(
      {
...
var rs = class rs2 {
   ...
   */
  static apply(t) {
    rs2.initialized || (BufferGeometry.prototype.computeBoundsTree = sn, BufferGeometry.prototype.disposeBoundsTree = en, Mesh.prototype.raycast = tn, rs2.initialized = true), t.boundsTree || t.computeBoundsTree();
  }
  /**
...
var Ee = class Ge {
  ...
  constructor(t, s, e) {
    ...
    P(this, "_settingVisibility", false);
  ...
  get uniqueVertices() {
    ...
    for (let i = 0; i < s.count; i++) {
      ...
      e.has(c) || (e.add(c), t.push(new Vector3(n, o, r)));
    }
    return t;
  }
  /**
  ...
  setVisibility(t, s = this.ids) {
    if (!this._settingVisibility) {
      if (this._settingVisibility = true, t)
        for (const e of s) {
  ...
  clone(t = this.ids) {
    ...
    for (const i of t) {
      ...
      const o = [], r = [];
      for (const c of n) {
        const f = new Matrix4(), l = new Color();
...
var ut = 4;
var Q = 4;
var xt = new Int32Array(2);
var Pe = new Float32Array(xt.buffer);
var Se = new Float64Array(xt.buffer);
var vs = new Uint16Array(new Uint8Array([1, 0]).buffer)[0] === 1;
var se;
(function(a) {
...
var Ut = class _Ut {
   ...
   */
  static allocate(t) {
    return new _Ut(new Uint8Array(t));
  }
  clear() {
    this.position_ = 0;
  }
...
var cs = class _cs {
  ...
  prep(t, s) {
    ...
    for (; this.space < e + t + s; ) {
      ...
      this.bb = _cs.growByteBuffer(this.bb), this.space += this.bb.capacity() - i;
    }
    this.pad(e);
  }
  pad(t) {
...
var nn = class {
  ...
  setInstances(t, s) {
    ...
    for (let f = 0; f < o.length; f++) {
      ...
      for (let I = 0; I < b; I++) {
        const y = c * 16, u = e.subarray(y, y + 17), p = new Matrix4().fromArray(u);
        if (h.push(p), i) {
          const w = c * 3, [m, g, A] = i.subarray(w, w + 4), F = new Color(m, g, A);
          d.push(F);
        }
        c++;
      }
  ...
  constructMaterials(t) {
    ...
    for (let i = 0; i < s.length; i += 5) {
      const n = s[i], o = !!s[i + 1], r = s[i + 2], c = s[i + 3], f = s[i + 4], l = new Color(r, c, f), b = new MeshLambertMaterial({
        color: l,
        opacity: n,
        transparent: o
      });
  ...
  constructFragmentGroup(t) {
    ...
    if (e) {
      const x = e.coordinationMatrixArray(), C = new Matrix4();
      x && C.fromArray(x), s.civilData = { alignments: /* @__PURE__ */ new Map(), coordinationMatrix: C };
      const v = e.alignmentsLength();
      for (let S = 0; S < v; S++) {
        const V = new LineBasicMaterial({ color: 16777215 }), M = new qe(), T = e.alignments(S);
        if (!T)
    ...
    const i = new Matrix4().elements, n = t.coordinationMatrixArray() || i, o = t.idsArray() || new Uint32Array(), r = t.itemsKeysIndicesArray() || new Uint32Array(), c = t.itemsKeysArray() || new Uint32Array(), f = t.itemsRelsArray() || new Uint32Array(), l = t.itemsRelsIndicesArray() || new Uint32Array(), h = (t.fragmentKeys() || "").split(this.fragmentIDSeparator);
  ...
  constructGeometry(t) {
    ...
    if (o.setIndex(Array.from(i)), o.setAttribute("position", new BufferAttribute(s, 3)), o.setAttribute("normal", new BufferAttribute(e, 3)), n)
  ...
  constructCivilCurves(t, s, e, i, n) {
    ...
    for (let r = 0; r < i; r++) {
      ...
      const b = c.data();
      b && (l = JSON.parse(b));
      const h = new EdgesGeometry(), d = new BufferAttribute(f, 3);
...
var dt = class _dt {
  ...
  static getRootAsCivilData(t, s) {
    return (s || new _dt()).__init(
      t.readInt32(t.position()) + t.position(),
      t
    );
  }
  static getSizePrefixedRootAsCivilData(t, s) {
    return t.setPosition(t.position() + Q), (s || new _dt()).__init(
      t.readInt32(t.position()) + t.position(),
      t
    );
  }
  ...
  static createCivilData(t, s, e) {
    return _dt.startCivilData(t), _dt.addAlignments(t, s), _dt.addCoordinationMatrix(t, e), _dt.endCivilData(t);
  }
};
var k = class _k {
  constructor() {
  ...
  static getRootAsFragment(t, s) {
    return (s || new _k()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  static getSizePrefixedRootAsFragment(t, s) {
    return t.setPosition(t.position() + Q), (s || new _k()).__init(t.readInt32(t.position()) + t.position(), t);
  }
  position(t) {
    const s = this.bb.__offset(this.bb_pos, 4);
    return s ? this.bb.readFloat32(this.bb.__vector(this.bb_pos + s) + t * 4) : 0;
  ...
  static createFragment(t, s, e, i, n, o, r, c, f, l, b, h, d) {
    return _k.startFragment(t), _k.addPosition(t, s), _k.addNormal(t, e), _k.addIndex(t, i), _k.addGroups(t, n), _k.addMaterials(t, o), _k.addMatrices(t, r), _k.addColors(t, c), _k.addItemsSize(t, f), _k.addIds(t, l), _k.addId(t, b), _k.addCapacity(t, h), _k.addCapacityOffset(t, d), _k.endFragment(t);
  }
};
var Hs = class ne {
  constructor() {
...
var on = class {
  ...
  constructFragmentGroup(t) {
    const s = new Ss(), e = t.civil();
    if (e) {
      const v = e.coordinationMatrixArray(), S = new Matrix4();
      v && S.fromArray(v), s.civilData = { alignments: /* @__PURE__ */ new Map(), coordinationMatrix: S };
      const V = e.alignmentsLength();
      for (let M = 0; M < V; M++) {
        const T = new LineBasicMaterial({ color: 16777215 }), D = new qe(), L = e.alignments(M);
        if (!L)
          throw new Error("Alignment not found!");
...
var rn = class {
  constructor(t) {
    ...
    P(this, "_isCleaningMemory", false);
    P(this, "cleanMemory", async () => {
      if (this._isCleaningMemory)
        return;
      this._isCleaningMemory = true;
      const t2 = await this.getDir(this.baseDirectory), s = /* @__PURE__ */ new Set(), e = (/* @__PURE__ */ new Date()).getTime();
      for await (const i of t2.values()) {
...
var N = class N2 extends Group {
  constructor() {
    super(...arguments);
    P(this, "items", []);
    P(this, "boundingBox", new Box3());
    P(this, "coordinationMatrix", new Matrix4());
  ...
  static setPropertiesDB(s) {
    s ? N2.propertiesDB || (N2.propertiesDB = new rn(
      "that-open-company-streaming-properties"
    )) : s || N2.propertiesDB && N2.propertiesDB.dispose();
  }
  /**
  ...
  async getAllPropertiesOfType(s) {
    if (this._properties) {
      ...
      for (const c in this._properties) {
        ...
        f.type === s && (o[f.expressID] = f, r = true);
      }
      return r ? o : null;
    }
  ...
  async getPropertiesData(s) {
    ...
    ), N2.url = this.streamSettings.baseUrl);
    let e;
    if (N2.useCache) {
      let n = null;
      if (N2.propertiesDB && (n = await N2.propertiesDB.get(s)), n)
        e = await n.text();
      else if (e = await (await N2.fetch(s)).text(), N2.propertiesDB) {
        const c = new TextEncoder().encode(e);
        await N2.propertiesDB.add(s, c);
      }
    } else
      e = await (await N2.fetch(s)).text();
    return JSON.parse(e);
  }
  constructFileName(s) {
...
var cn = class {
   ...
   */
  getSegment(t) {
    const s = this._index.array[t] * 3, e = this._index.array[t + 1] * 3, i = new Vector3(
      this._pos[s],
      this._pos[s + 1],
      this._pos[s + 2]
    ), n = new Vector3(
...
var Ke = class extends LineSegments {
  /**
...
var ot = class _ot {
  ...
  static getRootAsStreamedGeometry(t, s) {
    return (s || new _ot()).__init(
      t.readInt32(t.position()) + t.position(),
      t
    );
  }
  static getSizePrefixedRootAsStreamedGeometry(t, s) {
    return t.setPosition(t.position() + Q), (s || new _ot()).__init(
      t.readInt32(t.position()) + t.position(),
      t
    );
  }
  ...
  static createStreamedGeometry(t, s, e, i, n) {
    return _ot.startStreamedGeometry(t), _ot.addGeometryId(t, s), _ot.addPosition(t, e), _ot.addNormal(t, i), _ot.addIndex(t, n), _ot.endStreamedGeometry(t);
  }
};
var At = class _At {
  constructor() {
  ...
  static getRootAsStreamedGeometries(t, s) {
    return (s || new _At()).__init(
      t.readInt32(t.position()) + t.position(),
      t
    );
  }
  static getSizePrefixedRootAsStreamedGeometries(t, s) {
    return t.setPosition(t.position() + Q), (s || new _At()).__init(
      t.readInt32(t.position()) + t.position(),
      t
    );
  }
  ...
  static createStreamedGeometries(t, s) {
    return _At.startStreamedGeometries(t), _At.addGeometries(t, s), _At.endStreamedGeometries(t);
  }
};
var hn = class {
  /**
...
//# sourceMappingURL=chunk-AQWLDVQX.js.map
