...
var Ur = (i, t, e) => t in i ? Hr(i, t, { enumerable: true, configurable: true, writable: true, value: e }) : i[t] = e;
var Nt = (i, t, e) => (Ur(i, typeof t != "symbol" ? t + "" : t, e), e);
var Kt = Math.min;
var ft = Math.max;
var li = Math.round;
var At = (i) => ({
...
var Qr = async (i, t, e) => {
  ...
  for (let v = 0; v < a.length; v++) {
    ...
    }, $ && m <= 50 && (m++, typeof $ == "object" && ($.placement && (p = $.placement), $.rects && (c = $.rects === true ? await r.getElementRects({
      reference: i,
      floating: t,
      strategy: o
    }) : $.rects), {
...
function Xn(i) {
  return typeof ShadowRoot > "u" ? false : i instanceof ShadowRoot || i instanceof K(i).ShadowRoot;
}
function Be(i) {
  const {
    overflow: t,
...
function xn(i) {
  ...
  return e.transform !== "none" || e.perspective !== "none" || (e.containerType ? e.containerType !== "normal" : false) || !t && (e.backdropFilter ? e.backdropFilter !== "none" : false) || !t && (e.filter ? e.filter !== "none" : false) || ["transform", "perspective", "filter"].some((n) => (e.willChange || "").includes(n)) || ["paint", "layout", "strict", "content"].some((n) => (e.contain || "").includes(n));
}
function sa(i) {
  let t = te(i);
  for (; ht(t) && !Ei(t); ) {
...
function la(i, t, e) {
  return t === void 0 && (t = false), !e || t && e !== K(i) ? false : t;
}
function Oe(i, t, e, n) {
...
function da(i) {
  ...
  const s = o === "fixed", r = Tt2(n), a = t ? ss(t.floating) : false;
  if (n === r || a && s)
    return e;
  let l = {
    scrollLeft: 0,
...
function rs(i) {
  return Oe(Tt2(i)).left + Si(i).scrollLeft;
}
function ha(i) {
  const t = Tt2(i), e = Si(i), n = i.ownerDocument.body, o = ft(t.scrollWidth, t.clientWidth, n.scrollWidth, n.clientWidth), s = ft(t.scrollHeight, t.clientHeight, n.scrollHeight, n.clientHeight);
...
function pa(i, t) {
  const e = K(i), n = Tt2(i), o = e.visualViewport;
...
function ma(i, t) {
  const e = Oe(i, true, t === "fixed"), n = e.top + i.clientTop, o = e.left + i.clientLeft, s = ht(i) ? Qt(i) : At(1), r = i.clientWidth * s.x, a = i.clientHeight * s.y, l = o * s.x, c = n * s.y;
  return {
    width: r,
    height: a,
    x: l,
...
function as(i, t) {
  const e = te(i);
  return e === t || !ut(e) || Ei(e) ? false : nt(e).position === "fixed" || as(e, t);
}
function fa2(i, t) {
  const e = t.get(i);
  if (e)
    return e;
  let n = sn(i, [], false).filter((a) => ut(a) && Et(a) !== "body"), o = null;
...
function ba(i) {
  ...
  const s = [...e === "clippingAncestors" ? fa2(t, this._c) : [].concat(e), n], r = s[0], a = s.reduce((l, c) => {
    const h = Jn(t, c, o);
...
function va(i, t, e) {
  const n = ht(t), o = Tt2(t), s = e === "fixed", r = Oe(i, true, s, t);
  let a = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
var ii = globalThis;
var Cn = ii.ShadowRoot && (ii.ShadyCSS === void 0 || ii.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var An = Symbol();
var Kn = /* @__PURE__ */ new WeakMap();
var ps = class {
  constructor(i, t, e) {
    if (this._$cssResult$ = true, e !== An)
...
var xa = (i) => new ps(typeof i == "string" ? i : i + "", void 0, An);
var R = (i, ...t) => {
...
var Zn = Cn ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const n of t.cssRules)
    e += n.cssText;
  return xa(e);
})(i) : i;
var { is: Ca, defineProperty: Aa, getOwnPropertyDescriptor: Ea, getOwnPropertyNames: Sa, getOwnPropertySymbols: ka, getPrototypeOf: Ta } = Object;
var ee = globalThis;
var to = ee.trustedTypes;
var Oa = to ? to.emptyScript : "";
var eo = ee.reactiveElementPolyfillSupport;
var xe = (i, t) => i;
var di = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? Oa : null;
      break;
...
var En = (i, t) => !Ca(i, t);
var io = { attribute: true, type: String, converter: di, reflect: false, hasChanged: En };
...
var Xt = class extends HTMLElement {
  ...
  static finalize() {
    if (this.hasOwnProperty(xe("finalized")))
      return;
    if (this.finalized = true, this._$Ei(), this.hasOwnProperty(xe("properties"))) {
  ...
  P(t, e, n) {
    this._$AL.has(t) || this._$AL.set(t, e), n.reflect === true && this._$Em !== t && (this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Set())).add(t);
  }
  async _$ET() {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (o.size > 0)
        for (const [s, r] of o)
          r.wrapped !== true || this._$AL.has(s) || this[s] === void 0 || this.P(s, this[s], r);
    }
    let e = false;
    const n = this._$AL;
    try {
...
var ui = globalThis;
var hi = ui.trustedTypes;
var no = hi ? hi.createPolicy("lit-html", { createHTML: (i) => i }) : void 0;
var ms2 = "$lit$";
var xt = `lit$${Math.random().toFixed(9).slice(2)}$`;
var fs = "?" + xt;
var Ia = `<${fs}>`;
var Ht = document;
var Ie = () => Ht.createComment("");
var Re = (i) => i === null || typeof i != "object" && typeof i != "function";
var Sn = Array.isArray;
var Ra = (i) => Sn(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function";
var Ui = `[ 	
\f\r]`;
var ve = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;
var oo = /-->/g;
var so = />/g;
var Mt2 = RegExp(`>|${Ui}(?:([^\\s"'>=/]+)(${Ui}*=${Ui}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g");
var ro = /'/g;
var ao = /"/g;
var bs = /^(?:script|style|textarea|title)$/i;
var Pa = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e });
var f = Pa(1);
var Ut = Symbol.for("lit-noChange");
var j = Symbol.for("lit-nothing");
var lo = /* @__PURE__ */ new WeakMap();
var Dt = Ht.createTreeWalker(Ht, 129);
function gs(i, t) {
...
var Na = (i, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    for (; p < l.length && (r.lastIndex = p, h = r.exec(l), h !== null); )
      p = r.lastIndex, r === ve ? h[1] === "!--" ? r = oo : h[1] !== void 0 ? r = so : h[2] !== void 0 ? (bs.test(h[2]) && (o = RegExp("</" + h[2], "g")), r = Mt2) : h[3] !== void 0 && (r = Mt2) : r === Mt2 ? h[0] === ">" ? (r = o ?? ve, u = -1) : h[1] === void 0 ? u = -2 : (u = r.lastIndex - h[2].length, c = h[1], r = h[3] === void 0 ? Mt2 : h[3] === '"' ? ao : ro) : r === ao || r === ro ? r = Mt2 : r === oo || r === so ? r = ve : (r = Mt2, o = void 0);
    const d = r === Mt2 && i[a + 1].startsWith("/>") ? " " : "";
    s += r === ve ? l + Ia : u >= 0 ? (n.push(c), l.slice(0, u) + ms2 + l.slice(u) + xt + d) : l + xt + (u === -2 ? a : d);
  }
...
function ie2(i, t, e = i, n) {
  var o, s;
  if (t === Ut)
    return t;
  let r = n !== void 0 ? (o = e.o) == null ? void 0 : o[n] : e.l;
  const a = Re(t) ? void 0 : t._$litDirective$;
  return (r == null ? void 0 : r.constructor) !== a && ((s = r == null ? void 0 : r._$AO) == null || s.call(r, false), a === void 0 ? r = void 0 : (r = new a(i), r._$AT(i, e, n)), n !== void 0 ? (e.o ?? (e.o = []))[n] = r : e.l = r), r !== void 0 && (t = ie2(i, r._$AS(i, t.values), r, n)), t;
}
var Ma = class {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: n } = this._$AD, o = ((t == null ? void 0 : t.creationScope) ?? Ht).importNode(e, true);
    Dt.currentNode = o;
...
var He = class _He {
  ...
  constructor(t, e, n, o) {
    this.type = 2, this._$AH = j, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = n, this.options = o, this.v = (o == null ? void 0 : o.isConnected) ?? true;
  }
  get parentNode() {
  ...
  _$AI(t, e = this) {
    t = ie2(this, t, e), Re(t) ? t === j || t == null || t === "" ? (this._$AH !== j && this._$AR(), this._$AH = j) : t !== this._$AH && t !== Ut && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Ra(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  k(t) {
    ...
    let n, o = 0;
    for (const s of t)
      o === e.length ? e.push(n = new _He(this.O(Ie()), this.O(Ie()), this, this.options)) : n = e[o], n._$AI(s), o++;
...
var ki = class {
  ...
  _$AI(t, e = this, n, o) {
    ...
    let r = false;
    if (s === void 0)
      t = ie2(this, t, e, 0), r = !Re(t) || t !== this._$AH && t !== Ut, r && (this._$AH = t);
    else {
      const a = t;
      let l, c;
      for (t = s[0], l = 0; l < s.length - 1; l++)
        c = ie2(this, a[n + l], e, l), c === Ut && (c = this._$AH[l]), r || (r = !Re(c) || c !== this._$AH[l]), c === j ? t = j : t !== j && (t += (c ?? "") + s[l + 1]), this._$AH[l] = c;
    }
    r && !o && this.j(t);
  }
  j(t) {
...
var Fa = class extends ki {
  constructor(t, e, n, o, s) {
    super(t, e, n, o, s), this.type = 5;
  }
  _$AI(t, e = this) {
    if ((t = ie2(this, t, e, 0) ?? j) === Ut)
      return;
...
var co = ui.litHtmlPolyfillSupport;
...
var uo;
I._$litElement$ = true, I.finalized = true, (uo = globalThis.litElementHydrateSupport) == null || uo.call(globalThis, { LitElement: I });
var ho = globalThis.litElementPolyfillSupport;
ho == null || ho({ LitElement: I });
(globalThis.litElementVersions ?? (globalThis.litElementVersions = [])).push("4.1.0");
var ja = { attribute: true, type: String, converter: di, reflect: false, hasChanged: En };
var Ba = (i = ja, t, e) => {
...
function b(i) {
  return (t, e) => typeof e == "object" ? Ba(i, t, e) : ((n, o, s) => {
    ...
    return o.constructor.createProperty(s, r ? { ...n, wrapped: true } : n), r ? Object.getOwnPropertyDescriptor(o, s) : void 0;
  })(i, t, e);
}
function le(i) {
  return b({ ...i, state: true, attribute: false });
}
var Ha = (i) => i.strings === void 0;
var vs = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 };
var ys = (i) => (...t) => ({ _$litDirective$: i, values: t });
var _s = class {
  constructor(t) {
  }
  get _$AU() {
...
var $e = (i, t) => {
  ...
  if (n === void 0)
    return false;
  for (const o of n)
    (e = o._$AO) == null || e.call(o, t, false), $e(o, t);
  return true;
};
var pi = (i) => {
  let t, e;
...
function po(i) {
  ...
  return t.width = e("width", null), t.height = e("height", null), t.rotate = Xa(e("rotate", "")), Qa2(t, e("flip", "")), t.preserveAspectRatio = e("preserveAspectRatio", e("preserveaspectratio", "")), t;
}
function Ka(i, t) {
  for (const e in Cs)
    if (i[e] !== t[e])
...
var ni = (i, t) => i ? !!((i.provider === "" || i.provider.match(Ce)) && (t && i.prefix === "" || i.prefix.match(Ce)) && i.name.match(Ce)) : false;
function Za(i, t) {
  const e = {};
...
function Me(i) {
  const t = typeof i == "string" ? Ve(i, true, Ne) : i;
  if (t) {
    ...
    t.forEach((s) => {
      ...
      r.pending = r.pending.filter((l) => {
        ...
        if (i.icons[c])
          ...
          return e = true, true;
        return false;
      }), r.pending.length !== a && (e || Ts2([i], s.id), s.callback(
        r.loaded.slice(0),
        r.missing.slice(0),
        r.pending.slice(0),
        s.abort
...
var cl = 0;
function dl(i, t, e) {
  const n = cl++, o = Ts2.bind(null, e, n);
  if (!t.pending.length)
    return o;
  const s = {
    id: n,
...
function vo(i, t) {
  const e = Tn(t);
  return e === null ? false : (Ti[i] = e, true);
}
function Oi(i) {
  return Ti[i];
}
...
function un(i, t) {
  return On(i, Rs2, t.toString());
}
function hn(i) {
  return parseInt(dn(i, Rs2)) || 0;
}
var zt = {
  local: true,
  session: true
  ...
  if (!In) {
    ...
    for (const i in zt)
      Ls(i, (t) => {
        ...
        return s.lastModifiedCached = s.lastModifiedCached ? Math.min(s.lastModifiedCached, r) : r, true;
      });
  }
}
function yl(i, t) {
...
var $l = (i) => new Promise((t, e) => {
  const n = typeof i == "string" ? Ve(i, true) : i;
  if (!n) {
    e(i);
    return;
  }
...
function Al(i, t) {
  const e = typeof i == "string" ? Ve(i, true, true) : null;
  if (!e) {
    const s = Cl(i);
    return {
      value: i,
...
function Hs() {
  ...
  return {
    enableCache: (t) => Co(t, true),
    disableCache: (t) => Co(t, false),
    iconLoaded: bo,
    iconExists: bo,
    getIcon: rl,
    listIcons: sl,
...
function Xl(i = "iconify-icon") {
  ...
  const o = [
     ...
     */
    constructor() {
      super(), Nt(this, "_shadowRoot"), Nt(this, "_initialised", false), Nt(this, "_state"), Nt(this, "_checkQueued", false), Nt(this, "_connected", false), Nt(this, "_observer", null), Nt(this, "_visible", true);
    ...
    */
     ...
     */
    _gotIconData(a) {
      this._checkQueued = false, this._renderIcon(a, po(this), this.getAttribute("mode"));
    }
    /**
...
var Nn2 = (V = class extends I {
  ...
  static removeMenus() {
    for (const i of V.menus)
      i instanceof V && (i.visible = false);
  ...
  i.target === V.dialog && V.removeMenus();
    ...
    ></dialog>`), V.menus = [], V);
Ws([
  b({ type: String, reflect: true })
], Nn2.prototype, "placement");
Ws([
  b({ type: Boolean, reflect: true })
], Nn2.prototype, "visible");
var bn = Nn2;
var tc = Object.defineProperty;
var ec2 = Object.getOwnPropertyDescriptor;
var lt = (i, t, e, n) => {
  for (var o = n > 1 ? void 0 : n ? ec2(t, e) : t, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (o = (n ? r(t, e, o) : r(o)) || o);
  return n && o && tc(t, e, o), o;
};
var ye;
var ot = (ye = class extends I {
  constructor() {
    super(), this.labelHidden = false, this.active = false, this.disabled = false, this.vertical = false, this.tooltipVisible = false, this._stateBeforeLoading = {
      disabled: false,
      icon: ""
    }, this._loading = false, this._parent = oe(), this._tooltip = oe(), this._mouseLeave = false, this.onClick = (i) => {
...
lt([
  b({ type: Boolean, attribute: "label-hidden", reflect: true })
], ot.prototype, "labelHidden", 2);
lt([
  b({ type: Boolean, reflect: true })
], ot.prototype, "active", 2);
lt([
  b({ type: Boolean, reflect: true, attribute: "disabled" })
...
lt([
  b({ type: Number, attribute: "tooltip-time", reflect: true })
], ot.prototype, "tooltipTime", 2);
lt([
  b({ type: Boolean, attribute: "tooltip-visible", reflect: true })
], ot.prototype, "tooltipVisible", 2);
lt([
  b({ type: String, attribute: "tooltip-title", reflect: true })
], ot.prototype, "tooltipTitle", 2);
lt([
  b({ type: String, attribute: "tooltip-text", reflect: true })
...
var qs = class extends I {
  constructor() {
    super(...arguments), this.vertical = false, this.color = "#bcf124", this._colorInput = oe(), this._textInput = oe(), this.onValueChange = new Event("input"), this.onOpacityInput = (t) => {
      const e = t.target;
...
var Ii = (i) => i === "true" || i === "false" ? i === "true" : i && !isNaN(Number(i)) && i.trim() !== "" ? Number(i) : i;
var sc = [">=", "<=", "=", ">", "<", "?", "/", "#"];
function Io(i) {
  const t = sc.find(
...
It([
  b({ type: Boolean, attribute: "no-mark", reflect: true })
...
var Xs = class extends Y {
  constructor() {
    super(), this.multiple = false, this.required = false, this.vertical = false, this._visible = false, this._value = /* @__PURE__ */ new Set(), this.onValueChange = new Event("change"), this._contextMenu = oe(), this.onOptionClick = (t) => {
  ...
  findOption(t) {
    return this._options.find((e) => e instanceof W ? e.label === t || e.value === t : false);
  }
  render() {
    let t, e, n;
...
Js([
  b({ type: Boolean, reflect: true })
], Mn2.prototype, "floating");
Js([
  b({ type: String, reflect: true })
], Mn2.prototype, "layout");
...
qe([
  b({ type: Boolean, attribute: "icon-hidden", reflect: true })
...
var tr = class extends I {
  constructor() {
    super(...arguments), this._value = 0, this.vertical = false, this.slider = false, this._input = oe(), this.onValueChange = new Event("change");
  }
  set value(t) {
  ...
  onSliderMouseDown(t) {
    ...
    const s = (l) => {
      ...
      document.removeEventListener("mousemove", s), document.body.style.cursor = "default", o ? o = false : (this.addEventListener("blur", r), this.slider = false, requestAnimationFrame(() => this.focus())), document.removeEventListener("mouseup", a);
    };
...
Ye([
  b({ type: Boolean, attribute: "header-hidden", reflect: true })
...
var nr = class extends I {
  ...
  onSlotChange(t) {
    const e = t.target.assignedElements();
    for (const n of e)
      n instanceof W && (n.noMark = true, n.removeEventListener("click", this.onOptionClick), n.addEventListener("click", this.onOptionClick));
  }
  findOption(t) {
    return this._options.find((e) => e instanceof W ? e.label === t || e.value === t : false);
  }
...
var cr = lr;
Sc([
  b({ type: Boolean, attribute: "children-hidden", reflect: true })
...
me([
  b({ type: Boolean, attribute: "is-header", reflect: true })
...
var ur = class extends I {
  ...
  generateText(t = "comma", e = this.value, n = "", o = true) {
...
ct([
  b({ type: String, attribute: "min-col-width", reflect: true })
...
ct([
  b({ type: Boolean, reflect: true, attribute: "selectable-rows" })
], rt.prototype, "selectableRows", 2);
ct([
  b({ attribute: false })
], rt.prototype, "selection", 2);
ct([
  b({ type: Boolean, attribute: "no-indentation", reflect: true })
...
var pr = class extends I {
  ...
  onSlotChange(t) {
    ...
    const e = t.target.assignedElements(), n = e.find((o) => o instanceof it ? this.tab ? o.name === this.tab : !o.hidden : false);
    ...
    for (const o of e) {
      ...
      o.removeEventListener("hiddenchange", this.onTabHiddenChange), n !== o && (o.hidden = true), o.addEventListener("hiddenchange", this.onTabHiddenChange);
    }
  }
  render() {
    return f`
...
fe([
  b({ type: Boolean, attribute: "switchers-hidden", reflect: true })
...
fe([
  b({ type: Boolean, attribute: "switchers-full", reflect: true })
...
Ln([
  b({ type: Boolean, attribute: "labels-hidden", reflect: true })
...
var Gc = (i) => {
  const { components: t } = i, e = t.get(Nn);
  return f`
    <bim-button
...
var Xc = (i) => {
  const { components: t, dataStyles: e, onTopicEnter: n } = i, o = t.get(Mt), s = i.topics ?? o.list.values();
  return f`
    ...
    if (!a)
      return;
    const l = a;
    l.hiddenColumns = ["Guid"], l.columns = ["Title"], l.selectableRows = true, l.dataTransform = {
      Title: (c, h) => {
        const { Guid: u } = h;
        if (typeof u != "string")
          return c;
...
var xr = (i, t = true) => {
  ...
  if (t) {
    const { components: n, topics: o } = i, [, s] = e, r = n.get(Mt);
...
var Qc = (i) => {
  ...
  const { components: t, topic: e, actions: n } = i, o = {
    ...
    unlink: !!e,
    ...n
  }, s = t.get(ie), r = ((c = i.topic) == null ? void 0 : c.viewpoints) ?? s.list.keys(), a = [];
  for (const h of r) {
  ...
  return f`
    ...
    }), u.headersHidden = true, u.hiddenColumns = ["Guid"], u.columns = ["Title", { name: "Actions", width: "auto" }], u.dataTransform = {
      Actions: (p, d) => {
        const { Guid: m } = d;
        ...
        return v ? f`
          ...
          ${Object.values(o).includes(true) ? f`
...
var ed = (i) => {
  const { topic: t, styles: e, viewpoint: n, actions: o } = i, s = { delete: true, ...o };
  return f`<bim-table @cellcreated=${({ detail: a }) => {
    ...
    if (!a)
      return;
    const l = a;
    l.headersHidden = true, l.hiddenColumns = ["guid", "author"], l.dataTransform = {
      Comment: (h, u) => {
        const { guid: p } = u;
        if (typeof p != "string")
          return h;
...
var id = Object.freeze(Object.defineProperty({
  __proto__: null,
  topicComments: $r
}, Symbol.toStringTag, { value: "Module" }));
var si = {
...
var [_i, sd] = Y.create((i) => {
  const { components: t, topic: e } = i;
  let n;
  if (t) {
    const a = [...t.get(Mt).list.values()].filter(
      (l) => l !== e
    );
    n = xr({
      components: t,
      topics: a
    })[0], n.selectableRows = true, n.hiddenColumns = ["Guid", "Author", "Assignee", "Date", "DueDate"];
  }
  const o = () => {
...
var ad = (i, t = true) => {
  ...
  if (t) {
    ...
    n.get(Mt).list.onItemUpdated.add(({ value: a }) => {
...
var ld = Object.freeze(Object.defineProperty({
  __proto__: null,
  topicData: ad
}, Symbol.toStringTag, { value: "Module" }));
var hh = {
...
var cd = (i) => {
  const { components: t, actions: e, tags: n } = i, o = (e == null ? void 0 : e.dispose) ?? true, s = (e == null ? void 0 : e.download) ?? true, r = (e == null ? void 0 : e.visibility) ?? true, a = (n == null ? void 0 : n.schema) ?? true, l = (n == null ? void 0 : n.viewDefinition) ?? true, c = t.get(Tt), h = ({
    detail: p
  }) => {
    const { cell: d } = p;
    ...
    d.dataTransform = {
      Name: (v, _) => {
        ...
        return s && (D = f`<bim-button @click=${() => {
          ...
          M.type = "file", M.accept = ".ifc", M.multiple = false, M.addEventListener("change", async () => {
            if (!(M.files && M.files.length === 1))
              return;
            const S = M.files[0], P = await S.arrayBuffer(), tt = await t.get(yn).saveToIfc(
              x,
              new Uint8Array(P)
            ), B = new File(
              [tt],
...
var dd = (i, t = true) => {
  ...
  if (t) {
    const { components: n } = i, o = n.get(Tt), [, s] = e;
...
async function ri(i, t, e, n = Cr, o = false) {
  const s = i.get(kt), r = await t.getProperties(e);
  if (!r)
    return {
  ...
  for (const c in r) {
    const h = n.map((p) => typeof p == "string" ? c === p : p(c)).includes(true);
    if (!(c === "type" || h))
      continue;
    const u = r[c];
    if (u)
...
var md = Object.freeze(Object.defineProperty({
  __proto__: null,
  entityAttributes: pd
}, Symbol.toStringTag, { value: "Module" }));
var _t;
var fd = (i) => {
  const { components: t, classifications: e } = i, n = t.get(xi), o = t.get(Mn);
  _t || (_t = document.createElement("bim-table"), _t.headersHidden = true, _t.hiddenColumns = ["system"], _t.columns = ["Name", { name: "Actions", width: "auto" }], _t.dataTransform = {
    Actions: (r, a) => {
...
var _d = async (i, t) => {
  ...
  for (const c of t) {
    if (c.type === IFCMATERIALLAYERSETUSAGE) {
...
var Er = async (i, t) => {
  ...
  const e = Object.values(
    await i.getAllPropertiesOfType(IFCUNITASSIGNMENT)
  )[0];
  let n;
...
var Ad = ["OwnerHistory", "ObjectPlacement", "CompositionType"];
var Sr = async (i, t) => {
  const n = { ...{
...
var Ed = async (i, t, e, n, o) => {
  const r = i.get(kt).getEntityRelations(
    t,
    e,
    "IsDefinedBy"
  );
  if (r) {
    ...
    for (const u of r) {
      const p = await t.getProperties(u);
      p && (p.type === IFCPROPERTYSET && a.push(p), p.type === IFCELEMENTQUANTITY && l.push(p));
    }
...
var Sd = async (i, t, e, n) => {
  const s = i.get(kt).getEntityRelations(
    t,
    e,
    "HasAssociations"
  );
  if (s) {
    ...
    for (const h of s) {
      ...
      u && (u.type === IFCCLASSIFICATIONREFERENCE && r.push(u), (u.type === IFCMATERIALLAYERSETUSAGE || u.type === IFCMATERIALLAYERSET || u.type === IFCMATERIALLAYER || u.type === IFCMATERIAL || u.type === IFCMATERIALLIST) && a.push(u));
    }
    const l = await yd(
      t,
      r
...
var kd = async (i, t, e, n) => {
  ...
  if (s) {
    ...
    for (const l of s) {
      ...
      c && c.type === IFCTASK && r.push(c);
    }
    const a = await vd(i, t, r);
    a.children && se(n, a);
  }
};
var Td = async (i, t, e, n) => {
  const s = i.get(kt).getEntityRelations(
    t,
    e,
    "ContainedInStructure"
...
var Od = async (i, t, e) => {
  var a;
  const n = i.get(kt), o = i.get(Tt), s = o.getModelIdMap(t);
...
var Id = (i) => {
  ...
  return f`
    ...
    if (!a)
      return;
    const l = a;
    l.columns = [{ name: "Name", width: "12rem" }], l.headersHidden = true, l.loadFunction = () => Od(e, n, i), await l.loadData(true) && l.dispatchEvent(new Event("datacomputed"));
  })}>
      ${o ? f`
            <bim-label slot="missing-data" style="--bim-icon--c: gold" icon="ic:round-warning">
...
var Pd = Object.freeze(Object.defineProperty({
  __proto__: null,
  elementProperties: Rd
}, Symbol.toStringTag, { value: "Module" }));
var yn2 = async (i, t, e, n) => {
  var c;
  const o = [], s = i.get(kt), r = await t.getProperties(e);
  if (!r)
    return o;
  const { type: a } = r, l = {
    data: {
...
var mt;
var Md = (i, t) => {
  const e = i.get(Tt), { modelID: n, expressID: o, relations: s } = t.data;
  if (!n)
    return null;
...
var Ld = (i) => {
  ...
  mt || (mt = document.createElement("bim-table"), mt.hiddenColumns = ["modelID", "expressID", "relations"], mt.columns = ["Entity", "Name"], mt.headersHidden = true, mt.addEventListener("cellcreated", ({ detail: a }) => {
    const { cell: l } = a;
    l.column === "Entity" && !("Name" in l.rowData) && (l.style.gridColumn = "1 / -1");
  })), mt.addEventListener("rowcreated", (a) => {
    a.stopImmediatePropagation();
    const { row: l } = a.detail, c = t.get(fa), h = Md(t, l);
...
var Dd = (i, t = true) => {
  ...
  if (t) {
    const [, n] = e, { components: o } = i, s = o.get(Tt), r = o.get(kt), a = () => n({ models: s.groups.values() });
...
var _e = (i, t) => [...i.get(Or).list.values()].find((o) => o.world === t);
var zd = (i, t) => f`
    <bim-color-input @input=${(n) => {
  const o = n.target;
  i.color = new Color(o.color);
...
var Bd = (i, t) => {
  ...
  return f`
    ...
    s.lineColor = new Color(l).getHex(), c && (s.opacity = c / 100);
  }} color=${e} opacity=${n * 100}></bim-color-input>
  `;
};
var Hd = (i, t) => f`
    <bim-color-input @input=${(n) => {
  const o = n.target, s = new Color(o.color);
...
var Gd = (i) => {
  const { components: t } = i, e = t.get(Ts);
  return f`
    <bim-table @cellcreated=${({
    detail: s
  }) => {
    ...
    r.preserveStructureOnFilter = true, r.dataTransform = {
      Value: (d, m) => {
        ...
        if (y === "Near Frustum" && x.three instanceof PerspectiveCamera && typeof d == "number") {
          const $ = x.three;
        ...
        if (y === "Far Frustum" && x.three instanceof PerspectiveCamera && typeof d == "number") {
          const $ = x.three;
        ...
        if (y === "Field of View" && x.three instanceof PerspectiveCamera && typeof d == "number") {
          const $ = x.three;
        ...
        if (y === "Intensity" && typeof d == "number") {
          if (m.Light && typeof m.Light == "string") {
            ...
            return $ && $ instanceof Light ? F($, "intensity", d, {
              slider: true,
              min: 0,
              max: 10,
              step: 0.1
          ...
          if (m.IsAOConfig && g instanceof Lr)
            return F(
        ...
        if (y === "Color" && typeof d == "string") {
          ...
          if (w && w instanceof Light)
            return zd(w, d);
          if (m.IsAOConfig && g instanceof Lr)
            return jd(g, d);
        }
        if (y === "Ambient Oclussion" && typeof d == "boolean" && m.IsAOConfig && g instanceof Lr)
          return Ud(g, d);
        if (y === "Half Resolution" && m.IsAOConfig && g instanceof Lr && typeof d == "boolean")
          return wt(
            g.postproduction.n8ao.configuration,
            "halfRes",
            d
          );
        if (y === "Screen Space Radius" && m.IsAOConfig && g instanceof Lr && typeof d == "boolean")
          return wt(
            g.postproduction.n8ao.configuration,
            "screenSpaceRadius",
            d
          );
        if (y === "Radius" && m.IsAOConfig && g instanceof Lr && typeof d == "number")
          return F(
            g.postproduction.n8ao.configuration,
            "aoRadius",
            d,
        ...
        if (y === "Denoise Samples" && m.IsAOConfig && g instanceof Lr && typeof d == "number")
          return F(
            g.postproduction.n8ao.configuration,
            "denoiseSamples",
            d,
        ...
        if (y === "Samples" && m.IsAOConfig && g instanceof Lr && typeof d == "number")
          return F(
            g.postproduction.n8ao.configuration,
            "aoSamples",
            d,
        ...
        if (y === "Denoise Radius" && m.IsAOConfig && g instanceof Lr && typeof d == "number")
          return F(
            g.postproduction.n8ao.configuration,
            "denoiseRadius",
            d,
        ...
        if (y === "Distance Falloff" && m.IsAOConfig && g instanceof Lr && typeof d == "number")
          return F(
            g.postproduction.n8ao.configuration,
            "distanceFalloff",
            d,
        ...
        if (y === "Directional Light" && m.Light && typeof m.Light == "string" && typeof d == "boolean") {
          ...
          return $ && $ instanceof Light ? wt($, "visible", d) : d;
        }
        ...
        return y === "Custom Effects" && m.IsCEConfig && g instanceof Lr && typeof d == "boolean" ? Wd(g, d) : y === "Color" && m.IsOutlineConfig && g instanceof Lr && typeof d == "string" ? Bd(g, d) : y === "Tolerance" && m.IsOutlineConfig && g instanceof Lr && typeof d == "number" ? F(
          g.postproduction.customEffects,
          "tolerance",
          d,
          { slider: true, min: 0, max: 6, step: 0.01 }
        ) : y === "Outline" && m.IsOutlineConfig && g instanceof Lr && typeof d == "boolean" ? wt(
          g.postproduction.customEffects,
          "outlineEnabled",
          d
        ) : y === "Gloss" && m.IsGlossConfig && g instanceof Lr && typeof d == "boolean" ? wt(
          g.postproduction.customEffects,
          "glossEnabled",
          d
        ) : y === "Min" && m.IsGlossConfig && g instanceof Lr && typeof d == "number" ? F(
          g.postproduction.customEffects,
          "minGloss",
          d,
          { slider: true, min: -0.5, max: 0.5, step: 0.01 }
        ) : y === "Max" && m.IsGlossConfig && g instanceof Lr && typeof d == "number" ? F(
          g.postproduction.customEffects,
          "maxGloss",
          d,
          { slider: true, min: -0.5, max: 0.5, step: 0.01 }
        ) : y === "Exponent" && m.IsGlossConfig && g instanceof Lr && typeof d == "number" ? F(
          g.postproduction.customEffects,
          "glossExponent",
          d,
          { slider: true, min: 0, max: 5, step: 0.01 }
        ) : y === "Gamma Correction" && m.IsGammaConfig && g instanceof Lr && typeof d == "boolean" ? Vd(g, d) : d;
      }
    };
    const a = [];
    for (const [, d] of e.list) {
      const { scene: m, camera: v, renderer: _ } = d, C = _e(t, d), x = {
        data: {
          Name: d instanceof Qa && d.name || d.uuid
        },
        children: []
      };
      if (m) {
        ...
        const y = m.three.children.filter(
          (w) => w instanceof DirectionalLight
        );
        for (const w of y) {
          const E = {
            data: {
...
var qd = (i, t = true) => {
  ...
  if (t) {
    ...
    o.get(Ts).list.onItemDeleted.add(() => n());
  }
  return e;
};
var Yd = Object.freeze(Object.defineProperty({
  __proto__: null,
...
var Se = globalThis;
var wi = Se.trustedTypes;
var Mo = wi ? wi.createPolicy("lit-html", { createHTML: (i) => i }) : void 0;
var kr = "$lit$";
var $t = `lit$${Math.random().toFixed(9).slice(2)}$`;
var Tr = "?" + $t;
var Xd = `<${Tr}>`;
var Vt = document;
var De = () => Vt.createComment("");
var Fe = (i) => i === null || typeof i != "object" && typeof i != "function";
var Fn = Array.isArray;
var Jd = (i) => Fn(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function";
var Ki = `[ 	
\f\r]`;
var we = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;
var Lo = /-->/g;
var Do = />/g;
var Lt = RegExp(`>|${Ki}(?:([^\\s"'>=/]+)(${Ki}*=${Ki}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g");
var Fo = /'/g;
var zo = /"/g;
var Or2 = /^(?:script|style|textarea|title)$/i;
var Qd = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e });
var zn = Qd(1);
var re = Symbol.for("lit-noChange");
var H = Symbol.for("lit-nothing");
var jo = /* @__PURE__ */ new WeakMap();
var Ft = Vt.createTreeWalker(Vt, 129);
function Ir(i, t) {
...
var Kd = (i, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    let c, h, u = -1, p = 0;
    for (; p < l.length && (r.lastIndex = p, h = r.exec(l), h !== null); )
      p = r.lastIndex, r === we ? h[1] === "!--" ? r = Lo : h[1] !== void 0 ? r = Do : h[2] !== void 0 ? (Or2.test(h[2]) && (o = RegExp("</" + h[2], "g")), r = Lt) : h[3] !== void 0 && (r = Lt) : r === Lt ? h[0] === ">" ? (r = o ?? we, u = -1) : h[1] === void 0 ? u = -2 : (u = r.lastIndex - h[2].length, c = h[1], r = h[3] === void 0 ? Lt : h[3] === '"' ? zo : Fo) : r === zo || r === Fo ? r = Lt : r === Lo || r === Do ? r = we : (r = Lt, o = void 0);
...
var ze = class _ze {
  constructor({ strings: t, _$litType$: e }, n) {
    ...
    if (this.el = _ze.createElement(c, n), Ft.currentNode = this.el.content, e === 2 || e === 3) {
      const u = this.el.content.firstChild;
      u.replaceWith(...u.childNodes);
    }
...
function ae(i, t, e = i, n) {
  ...
  return (o == null ? void 0 : o.constructor) !== s && ((a = o == null ? void 0 : o._$AO) == null || a.call(o, false), s === void 0 ? o = void 0 : (o = new s(i), o._$AT(i, e, n)), n !== void 0 ? (e._$Co ?? (e._$Co = []))[n] = o : e._$Cl = o), o !== void 0 && (t = ae(i, o._$AS(i, t.values), o, n)), t;
}
var Zd = class {
  constructor(t, e) {
    this._$AV = [], this._$AN = void 0, this._$AD = t, this._$AM = e;
  ...
  u(t) {
    const { el: { content: e }, parts: n } = this._$AD, o = ((t == null ? void 0 : t.creationScope) ?? Vt).importNode(e, true);
    Ft.currentNode = o;
...
var Qe = class _Qe {
  ...
  constructor(t, e, n, o) {
    this.type = 2, this._$AH = H, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = n, this.options = o, this._$Cv = (o == null ? void 0 : o.isConnected) ?? true;
  }
  get parentNode() {
    let t = this._$AA.parentNode;
    const e = this._$AM;
  ...
  k(t) {
    ...
    let n, o = 0;
    for (const s of t)
      o === e.length ? e.push(n = new _Qe(this.O(De()), this.O(De()), this, this.options)) : n = e[o], n._$AI(s), o++;
    o < e.length && (this._$AR(n && n._$AB.nextSibling, o), e.length = o);
  }
  _$AR(t = this._$AA.nextSibling, e) {
    var n;
...
var Zi = Se.litHtmlPolyfillSupport;
...
var su = (i) => i.strings === void 0;
var ru = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 };
var au = (i) => (...t) => ({ _$litDirective$: i, values: t });
var lu = class {
  constructor(t) {
  }
  get _$AU() {
...
var ke = (i, t) => {
  ...
  if (e === void 0)
    return false;
  for (const o of e)
    (n = o._$AO) == null || n.call(o, t, false), ke(o, t);
  return true;
};
var xi2 = (i) => {
  let t, e;
...
function cu(i) {
  this._$AN !== void 0 ? (xi2(this), this._$AM = i, Rr(this)) : this._$AM = i;
}
function du(i, t = false, e = 0) {
  const n = this._$AH, o = this._$AN;
  if (o !== void 0 && o.size !== 0)
    if (t)
      if (Array.isArray(n))
        for (let s = e; s < n.length; s++)
          ke(n[s], false), xi2(n[s]);
      else
        n != null && (ke(n, false), xi2(n));
    else
      ke(this, i);
}
var uu = (i) => {
...
var hu = class extends lu {
  ...
  _$AO(t, e = true) {
    var n, o;
    t !== this.isConnected && (this.isConnected = t, t ? (n = this.reconnected) == null || n.call(this) : (o = this.disconnected) == null || o.call(this)), e && (ke(this, t), xi2(this));
  }
  setValue(t) {
    if (su(this._$Ct))
...
var fu = (i) => {
  ...
  }), l = t.get(Mt), c = (n == null ? void 0 : n.title) ?? (e == null ? void 0 : e.title) ?? Rs.default.title, h = (n == null ? void 0 : n.status) ?? (e == null ? void 0 : e.status) ?? Rs.default.status, u = (n == null ? void 0 : n.type) ?? (e == null ? void 0 : e.type) ?? Rs.default.type, p = (n == null ? void 0 : n.priority) ?? (e == null ? void 0 : e.priority) ?? Rs.default.priority, d = (n == null ? void 0 : n.assignedTo) ?? (e == null ? void 0 : e.assignedTo) ?? Rs.default.assignedTo, m = (n == null ? void 0 : n.labels) ?? (e == null ? void 0 : e.labels) ?? Rs.default.labels, v = (n == null ? void 0 : n.stage) ?? (e == null ? void 0 : e.stage) ?? Rs.default.stage, _ = (n == null ? void 0 : n.description) ?? (e == null ? void 0 : e.description) ?? Rs.default.description, C = e != null && e.dueDate ? e.dueDate.toISOString().split("T")[0] : null, x = /* @__PURE__ */ new Set([...l.config.statuses]);
  h && x.add(h);
      ...
      <bim-panel-section ${J(L)} fixed label="New Topic" name="topic">
        ...
        <div style="display: flex; gap: 0.375rem">
          <bim-dropdown vertical label="Labels" name="labels" multiple>
            ${[...w].map((S) => f`<bim-option label=${S} .checked=${m ? [...m].includes(S) : false}></bim-option>`)}
          </bim-dropdown>
...
var ai = globalThis;
var jn = ai.ShadowRoot && (ai.ShadyCSS === void 0 || ai.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var Bn = Symbol();
var Bo = /* @__PURE__ */ new WeakMap();
var Pr = class {
  constructor(t, e, n) {
    if (this._$cssResult$ = true, n !== Bn)
      throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
...
var vu = (i) => new Pr(typeof i == "string" ? i : i + "", void 0, Bn);
var Hn = (i, ...t) => {
  const e = i.length === 1 ? i[0] : t.reduce((n, o, s) => n + ((r) => {
    if (r._$cssResult$ === true)
      return r.cssText;
...
var Ho = jn ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const n of t.cssRules)
    e += n.cssText;
  return vu(e);
})(i) : i;
var { is: _u, defineProperty: wu, getOwnPropertyDescriptor: xu, getOwnPropertyNames: $u, getOwnPropertySymbols: Cu, getPrototypeOf: Au } = Object;
var Ct = globalThis;
var Uo = Ct.trustedTypes;
var Eu = Uo ? Uo.emptyScript : "";
var en = Ct.reactiveElementPolyfillSupport;
var Te = (i, t) => i;
var $i = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? Eu : null;
      break;
...
var Un = (i, t) => !_u(i, t);
var Vo = { attribute: true, type: String, converter: $i, reflect: false, hasChanged: Un };
...
var Jt = class extends HTMLElement {
  ...
  static finalize() {
    if (this.hasOwnProperty(Te("finalized")))
      return;
    if (this.finalized = true, this._$Ei(), this.hasOwnProperty(Te("properties"))) {
...
var Wo;
jt._$litElement$ = true, jt.finalized = true, (Wo = globalThis.litElementHydrateSupport) == null || Wo.call(globalThis, { LitElement: jt });
var nn = globalThis.litElementPolyfillSupport;
nn == null || nn({ LitElement: jt });
(globalThis.litElementVersions ?? (globalThis.litElementVersions = [])).push("4.1.1");
var Su = { attribute: true, type: String, converter: $i, reflect: false, hasChanged: Un };
var ku = (i = Su, t, e) => {
  const { kind: n, metadata: o } = e;
  let s = globalThis.litPropertyMetadata.get(o);
  if (s === void 0 && globalThis.litPropertyMetadata.set(o, s = /* @__PURE__ */ new Map()), s.set(e.name, i), n === "accessor") {
...
function Tu(i) {
  return Q({ ...i, state: true, attribute: false });
}
var Ou = class extends Object3D {
...
var Iu = class {
  ...
  regenerate() {
    ...
    const Mr = new BufferAttribute(new Float32Array(k), 3), Lr2 = new BufferAttribute(new Float32Array(ji), 3), { main: Dr, secondary: Fr } = this.grids;
    Dr.geometry.setAttribute("position", Mr), Fr.geometry.setAttribute("position", Lr2);
  }
  newNumber(t) {
...
var Vn = class Vn2 extends jt {
  ...
  set components(t) {
    this.dispose();
    const n = t.get(Ts).create();
    this._world = n, n.scene = new ec(t), n.scene.setup(), n.renderer = new nf(t, this);
    const o = new _c(t);
    n.camera = o;
...
var kt2 = Vn;
Ke([
  Q({ type: String, attribute: "grid-color", reflect: true })
], kt2.prototype, "gridColor");
Ke([
  Q({ type: Number, attribute: "grid-scale-x", reflect: true })
], kt2.prototype, "gridScaleX");
Ke([
  Q({ type: Number, attribute: "grid-scale-y", reflect: true })
], kt2.prototype, "gridScaleY");
Ke([
  Q({ type: Number, attribute: "grid-offset-x", reflect: true })
], kt2.prototype, "gridOffsetX");
Ke([
  Q({ type: Number, attribute: "grid-offset-y", reflect: true })
], kt2.prototype, "gridOffsetY");
...
var at = Wn;
Pt([
  Q({ type: Number, reflect: true })
], at.prototype, "size");
Pt([
  Q({ type: String, attribute: "right-text", reflect: true })
], at.prototype, "rightText");
Pt([
  Q({ type: String, attribute: "left-text", reflect: true })
], at.prototype, "leftText");
Pt([
  Q({ type: String, attribute: "top-text", reflect: true })
], at.prototype, "topText");
Pt([
  Q({ type: String, attribute: "bottom-text", reflect: true })
], at.prototype, "bottomText");
Pt([
  Q({ type: String, attribute: "front-text", reflect: true })
], at.prototype, "frontText");
Pt([
  Q({ type: String, attribute: "back-text", reflect: true })
...
var Gn = class Gn2 extends jt {
  ...
  set components(t) {
    ...
    if (this._components = t, this.components) {
      const n = this.components.get(Ts);
  ...
  firstUpdated() {
    ...
    if (!(this.components && t && this.world))
      return;
    const e = new ec(this.components);
    ...
    const { postproduction: o } = n, s = new _c(this.components);
    this.world.camera = s;
    const r = this.components.get(Or).create(this.world);
    r.material.uniforms.uColor.value = new Color(4342338), r.material.uniforms.uSize1.value = 2, r.material.uniforms.uSize2.value = 8, o.enabled = true, o.customEffects.excludedMeshes.push(r.three), o.setPasses({ custom: true, ao: true, gamma: true }), o.customEffects.lineColor = 1513756;
  }
  onSlotChange() {
...
var _h = class {
   ...
   */
  static init() {
    Ee.defineCustomElement("bim-view-cube", at), Ee.defineCustomElement("bim-world-2d", kt2), Ee.defineCustomElement("bim-world", Ci);
  }
};
export {
  _h as Manager,
